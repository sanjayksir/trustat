...
<!-------------- For Attachment Drap drop upload End------------------>
 ...
 <!-------------- For Demo Video Drap drop upload start------------------>
 $(".dropzoneVideo").dropzone({
    url: '/backend/upload_file/uploadDone/', //url for the ajax to post
    width: 300, //width of the div
    height: 152, //height of the div
    ...
    textAlign: 'center', //css style for text-align
    lineHeight: 300, //vertical text align
    text: '<label class="ace-file-input ace-file-multiple"><input multiple="" id="id-input-file-3" type="file"><span class="ace-file-container" data-title="Drop Demo Video here or click to choose"><span class="ace-file-name" data-title="No File ..."><i class="ace-icon fa fa-file-video-o"></i></span></span><a class="remove" href="#"><i class=" ace-icon fa fa-times"></i></a></label>', //text inside the div
    uploadMode: 'single', //upload all files at once or upload single files, options: all or single
    progressContainer: '', //progress selector if null one will be created
...
<!-------------- For Demo Video Drap drop upload End------------------>

<!-------------- For Demo Audio Drap drop upload start------------------>
/*$('.dropzone22').dropzone ({
        url: '/spideybuzz/backend/upload_file/uploadAttachment/',
        init: function() {
            this.on("sending", function(file, xhr, formData){
...
*/
 $(".dropzoneAudio").dropzone({
    ...
    textAlign: 'center', //css style for text-align
    lineHeight: 300, //vertical text align
    text: '<label class="ace-file-input ace-file-multiple"><input multiple="" id="id-input-file-3" type="file"><span class="ace-file-container" data-title="Drop Demo Audio(MP3) here or click to choose"><span class="ace-file-name" data-title="No File ..."><i class="ace-icon fa fa-file-audio-o"></i></span></span><a class="remove" href="#"><i class=" ace-icon fa fa-times"></i></a></label>', //text inside the div
    uploadMode: 'single', //upload all files at once or upload single files, options: all or single
    progressContainer: '', //progress selector if null one will be created
     dropzoneWraper: 'nniicc-dropzoneParent', //wrap the dropzone div with custom class
    files: [], //Access to the files that are droped
    ...
    load: function(){
        console.log("render done");
			...
			var Audiofile =res.responseText;
 			allids2.push(Audiofile);
			$('#all_product_demo_audio_list').val(allids2.join(","));
			//alert(allids1);
			<!----------------Comma Separated Value--------------------->
         },
    uploadDone: function(){
...
<!-------------- For User Manual Drap drop upload start------------------>
 $(".dropzoneAttachment").dropzone({
     url: '/backend/upload_file/uploadAttachment/', //url for the ajax to post
    width: 300, //width of the div
    height: 152, //height of the div
    ...
    textAlign: 'center', //css style for text-align
    lineHeight: 300, //vertical text align
    text: '<label class="ace-file-input ace-file-multiple"><input multiple="" id="id-input-file-3" type="file"><span class="ace-file-container" data-title="Drop User Manual here or click to choose"><span class="ace-file-name" data-title="No File ..."><i class="ace-icon fa fa-file-text"></i></span></span><a class="remove" href="#"><i class=" ace-icon fa fa-times"></i></a></label>', //text inside the div
    uploadMode: 'single', //upload all files at once or upload single files, options: all or single
    progressContainer: '', //progress selector if null one will be created
    dropzoneWraper: 'nniicc-dropzoneParent', //wrap the dropzone div with custom class
    files: [], //Access to the files that are droped
	...
	success: function(res, responseText){
		...
		//alert(Attachment);
 		allids4.push(Attachment);
		$('#all_product_user_manual_list').val(allids4.join(","));
		// alert(allids4);
		<!----------------Comma Separated Value--------------------->
    },  
    uploadDone: function(){

...
class Ajax_pagination{
	...
	var $last_link			= 'Last';
	var $uri_segment		= 3;
	var $full_tag_open		= '<div class="panel-body penelPadd"><ul class="bottom-pagination">';
	var $full_tag_close		= '</ul></div>';
	var $first_tag_open		= '<li>';
	var $first_tag_close	= '</li>';
	var $last_tag_open		= '<li>';
	var $last_tag_close		= '</li>';
	var $cur_tag_open		= '<li><a href="javascript:void(0)"><b>';
	...
	function create_links(){
		...
		//echo '*==*'.$this->cur_page.'==ttt='.$this->per_page;
	...
	function getAJAXlink($count, $text) {//echo '***'.$count;

 ...
 <div class="main-container ace-save-state" id="main-container"> 
  ...
  <div class="main-content">
    ...
    <div class="main-content-inner">
      ...
      <div style="clear:both;height:40px;"><a href="<?php echo base_url()?>plant_master/list_assigned_activity_role" class="btn btn-primary pull-right" title="List Assigned Activities to roles">List Assigned Activities to roles</a></div>
  ...
  <div class="widget-box">
    ...
    <div class="widget-header">
      ...
      <h4 class="widget-title">Assign Activities to roles</h4>
...
<input type="hidden" name="is_edit" value="<?php echo ($this->uri->segment(3))?1:0;?>" />
		...
		<div class="form-group row">
            ...
            <select class="form-control" name="user" id="user" onchange="return get_locations(this.value);;">
			<?php if($SelectDD!=''){?><option value="">-Select the roles-</option>
            <?php }
 			//$plant_data = get_all_plants($user_id);
 			foreach($UserData as $res){?>
           <option value="<?php echo $res['id'];?>" <?php if($this->uri->segment(3)==$res['id']){echo 'selected';}?>> <?php echo $res['role_name_value'];?> - (<?php echo $res['role_name_slug'];?>)</option>
 			<?php }?>
            </select> 
			</div>
			
			<!--------------------------------- Locations Controller DD ------------------------ -->
			<div class="col-sm-4">
                <label for="form-field-8">Select Activities</label>
                <select class="form-control" name="location_controller_val" id="location_controller_val">
		 ...
		 function get_locations(id){
		 	if(id!=''){
				$.ajax({
				type:'POST',
				url:'<?php echo base_url().'plant_master/getAllRolesList'?>',
				data:{id:id},

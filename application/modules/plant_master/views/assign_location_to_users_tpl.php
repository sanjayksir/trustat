 ...
 <div class="main-container ace-save-state" id="main-container"> 
      ...
      <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        ...
        <ul class="breadcrumb">
          ...
          <li> <i class="ace-icon fa fa-home home-icon"></i> <a href="<?php echo site_url(); ?>">Home</a> </li>
				<?php  $constant = "Assign Locations to Location Controller User" ;?>
  ...
  <div class="widget-box">
    ...
    <div class="widget-header">
      ...
      <h4 class="widget-title">Assign Locations to Location Controller User</h4>
...
if( $this->uri->segment(3)!=''){
	...
	$SelectDD='1';
	$UserData = get_all_users_exclude_pc($user_id,'1');
}
...
<input type="hidden" name="is_edit" value="<?php echo ($this->uri->segment(3))?1:0;?>" />
		...
		<div class="form-group row">
			...
			<?php if($SelectDD!=''){?><option value="">-Select Locations Controller User-</option>
            <?php }
		 ...
		 function get_locations(id){
		 	if(id!=''){
				$.ajax({
				type:'POST',
				url:'<?php echo base_url().'plant_master/getActiveLocationList'?>',
				data:{id:id},

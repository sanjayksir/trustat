...
<input type="hidden" name="location_id" id="location_id" value="<?php echo  $get_user_details[0]['location_id']?>" />
		...
		<div class="form-group row">
			...
			<input name="location_code"  id="location_code" type="text" class="form-control" value="<?php echo $get_user_details[0]['location_code'];?>" readonly>
		...
		<div class="form-group row">
			...
			<input name="email_id" id="email_id" type="text" class="form-control" placeholder="Email Id" value="<?php echo $get_user_details[0]['email_id'];?>"  maxlength="100">
			</div>

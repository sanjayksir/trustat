...
<div class="main-container ace-save-state" id="main-container">
    ...
    <?php $label = 'Assigned Activity to Role'; ?>
                    ...
                    <div class="col-xs-12">
                        <div class="widget-box widget-color-blue">
                            <div class="widget-header widget-header-flat">
                                <h5 class="widget-title bigger lighter">List <?php echo $label; ?></h5> <?php //echo getLoyaltyPointsByIDNLID(3, "bar_code_activation_for_all_levels", 363); ?>
						...
						//echo anchor("plant_master/view_assign_loyalty_activity_role/" . $CLPAssignId, '<i class="fa fa-eye bigger-130"></i>', array('class' => 'green', 'title' => 'View'));
						
						if($CLPAssignId != ''){
							//echo anchor("plant_master/edit_assign_loyalty_activity_role/" . $CLPAssignId, '<i class="ace-icon fa fa-pencil-square-o bigger-130"></i>', array('class' => 'green', 'title' => 'Edit'));
							echo anchor("plant_master/view_assign_loyalty_activity_role/" . $CLPAssignId, '<i class="fa fa-eye bigger-130"></i>', array('class' => 'green', 'title' => 'View'));
						}else{
						//echo anchor("plant_master/add_assign_loyalty_activity_role/" . $listData['id'], '<i class="ace-icon fa fa-plus-square bigger-130"></i>', array('class' => 'green', 'title' => 'Add'));
						echo "No Data";
						}
						?>
                                                        </div>
...
<?php $this->load->view('../includes/admin_footer'); ?>
        ...
        */
            ...
            function likestatus($id) {
                ...
                $(document).ready(function () {
                    $.post("<?php echo base_url(); ?>spideybuzz_missing_people/status/" + $id, function (response) {
                        if (response == 0) {

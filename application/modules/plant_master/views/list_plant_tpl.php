                    ...
                    <div class="col-xs-12">
                        <div class="widget-box widget-color-blue">
                            <div class="widget-header widget-header-flat">
                                <h5 class="widget-title bigger lighter">Manage Plant</h5>
                                <div class="widget-toolbar">
                                    <a href="<?php echo base_url('plant_master/add_plant') ?>" class="btn btn-xs btn-warning" title="Add PLant">Add <?php echo $label; ?> </a>
                                </div>
                            </div>
                                    ...
                                    <form id="form-filter" action="" method="get" class="form-horizontal" >
                                        ...
                                        <div class="col-sm-6">
                                            <div class="input-group">
                                                <input type="text" name="search" id="search" value="<?= $this->input->get('search',null); ?>" class="form-control search-query" placeholder="Plant Code,Plant Name or Email id">
                                            ...
                                            foreach ($userListing as $listData) {
                                                ...
                                                <tr id="show<?php echo $listData['plant_id']; ?>">
                                                    ...
                                                    <?php if ($this->session->userdata('admin_user_id') == 0) { ?>
                                                        ...
                                                        <td><?php
                                                $plntCtl = assogned_users_of_the_plant($listData['created_by'], $listData['plant_id']);
                                                $explod_arr = explode(',', $plntCtl);
                                                echo implode('<br><hr>', $explod_arr);
                                                            ?></td>
                                                        <td><?php
                                            $product_name = productNameByAssignedPlants($listData['plant_id']);

 ...
 <div class="main-container ace-save-state" id="main-container"> 
      ...
      <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        ...
        <ul class="breadcrumb">
          ...
          <li> <i class="ace-icon fa fa-home home-icon"></i> <a href="<?php echo site_url(); ?>">Home</a> </li>
				<?php  $constant = "Assign Locations to Locations Controller" ;?>
  ...
  <div class="widget-box">
    ...
    <div class="widget-header">
      ...
      <h4 class="widget-title">Assign Locations to Locations Controller</h4>
...
<input type="hidden" name="is_edit" value="<?php echo ($this->uri->segment(3))?1:0;?>" />
		...
		<div class="form-group row">
			...
			<div class="col-sm-4">
                <label for="form-field-8">Select Locations Controller User</label>
                <select class="form-control" name="location_controller_val" id="location_controller_val">
                    <option value="">Select Locations Controller</option>
                </select> 
			</div>
			<!--------------------------------- Locations Controller DD ------------------------ -->
			...
			<div class="col-sm-4">
			  <label for="form-field-8">Select Locations(Press Ctrl to Select Multiple Locations)</label>
		 ...
		 function get_locations(id){
		 	if(id!=''){
				$.ajax({
				type:'POST',
				url:'<?php echo base_url().'plant_master/getActiveLocationListSA'?>',
				data:{id:id},
        ...
        function get_locations_controller(id){
            $('#locations').find('option').remove().end().append('<option value="0"></option>');
		 	if(id!=''){
				$.ajax({
				type:'POST',
				url:'<?php echo base_url().'plant_master/getActiveLocationControllerList'?>',
				data:{id:id},
				success:function(msg){
					$("#location_controller_val").html(msg);
				}
				})
		 	}
		 }     
...
$.ajax({
		...
		url: "<?php echo base_url(); ?>plant_master/save_assign_user_to_location/",
		data: dataSend,
		success: function (msg) { 
			if(parseInt(msg)==1){

...
<?php $this->load->view('../includes/admin_top_navigation');//echo '<pre>';print_r($plant_data);exit;?>
	<div class="main-container ace-save-state" id="main-container">
			...
			<?php $label = '/ Assign Product to Location';?>
										...
										$i++;
											...
											$status ='Inactive';
											   ...
											   <td><?php echo $i; ?></td>
												...
												<td><?php $products = get_assigned_products_list_to_location($listData['location_id']) ;
...
function change_status(id,val){
	 if(confirm("Are you sure want to change the location status?")){
  	$.ajax({
				type: "POST",

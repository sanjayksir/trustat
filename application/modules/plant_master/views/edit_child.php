      ...
      <input name="menu_id" id="menu_id" type="hidden" value="<?php echo $this->uri->segment(3);?>">
        <div class="widget-main">
          ...
          <div>
            ...
            <label for="form-field-9"><span class="form-control" ><?php echo $created_by;?></span></label>
          </div>
           <div>
            <label for="form-field-9"><span>Created On:</span></label>
            <label for="form-field-9"><span class="form-control" ><?php echo $created_on;?></span></label>
          </div>

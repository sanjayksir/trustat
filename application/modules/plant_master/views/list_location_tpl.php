										...
										$i++;
											...
											$status ='Inactive';
											   ...
											   <td><?php echo $listData['location_name']; ?></td>
                                                ...
                                                <td><?php 	$plntCtl =  assogned_users_of_the_plant($listData['created_by'],$listData['location_id']); 
															$explod_arr = explode(',',$plntCtl);
															echo implode('<br><hr>',$explod_arr );
															 
												?></td>
												 <td><?php $product_name= productNameByAssignedPlants($listData['location_id']); 

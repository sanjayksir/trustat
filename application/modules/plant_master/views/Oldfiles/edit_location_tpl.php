			...
			<div class="col-sm-4">
			  ...
			  <div class="widget-body">
				...
				<div class="widget-body">
					...
					<img src="<?php echo $get_user_details[0]['location_image'];?>" width="150px" height="120px;" title="<?php echo base_url().'uploads/location_images/'.$get_user_details[0]['location_image'];?>" />	<?php //echo base_url().'uploads/location_images/'.$get_user_details[0]['location_image'];?>				 
                </div>

      ...
      <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        ...
        <ul class="breadcrumb">
          ...
          <li> <i class="ace-icon fa fa-home home-icon"></i> <a href="<?php echo site_url(); ?>">Home</a> </li>
		 				...
		 				<?php if($this->uri->segment(2)=='edit_plant'){
	...
	$("form#user_frm").validate({
 		rules: {
   			plant_name:{
 						 ...
 						 //noSpace: true,
						 remote: {
                        	 	url: "<?php echo base_url().'plant_master/';?>checkPlantName",
                          	type: "post",
		...
		submitHandler: function(form) {
 		...
 		/*	formData 		= new FormData();
 			...
 			$.ajax({
 				...
 				url: "<?php echo base_url(); ?>plant_master/save_plant/",
 				data: dataSend,
				success: function (msg) {
					if(parseInt(msg)==1){
						...
						$('#ajax_msg').text("Plant Aalready Exists!").css("color","red").show();
  					      window.location.href="<?php echo base_url(); ?>plant_master/list_plants/";						
					}
					else{

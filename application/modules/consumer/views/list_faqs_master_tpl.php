 						...
 						<div class="row">
							<div class="col-xs-12">
 								<div class="widget-box widget-color-blue">
                                                                    ...
                                                                    <h5 class="widget-title bigger lighter">List <?php echo "FAQs";?></h5>
                                                                    <div class="widget-toolbar">
                                                                  <a href="<?php echo base_url('consumer/add_faqs_master') ?>" class="btn btn-xs btn-warning" title="Add User">Add <?php echo $label; ?> </a> 
                                                                    </div>
                                                                </div>
            ...
            <form id="form-filter" action="" method="get" class="form-horizontal" >
                ...
                <div class="col-sm-6">
                    <div class="input-group">
                        <input type="text" name="search" id="search" value="<?= $this->input->get('search',null); ?>" class="form-control search-query" placeholder="FAQs">
                        ...
                        <table id="missing_people" class="table table-striped table-bordered table-hover">
                            ...
                            <tbody>
                                    ...
                                    if(count($userListing)>0){
										...
										<tr id="show<?php echo $listData['faq_id']; ?>">
                                           <td><?php echo $sno;$sno++; ?></td>
										   <td><?php echo $listData['faq_type']; ?></td>
                                           <td><?php echo $listData['faq_question']; ?></td>
                                           <td><?php echo $listData['faq_answer']; ?></td>
                                                 ...
                                                 <td>
                                                    ...
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                       ...
                                                       <a href="<?php echo base_url().'consumer/view_faqs_master/'.$listData['faq_id'];?>" class="btn btn-xs btn-success" target="_blank" title="View"><i class="fa fa-eye"></i></a>
                                                         <?php echo anchor("consumer/edit_faqs_master/" . $listData['faq_id'], '<i class="ace-icon fa fa-pencil bigger-130"></i>', array('class' => 'btn btn-xs btn-info','title'=>'Edit')); ?>
														 
                                                       <a title="Delete User" href="javascript:void(0);" onclick="return confirmDelete('<?php echo base64_encode($listData['faq_id']);?>');" class="btn btn-xs btn-danger"><i class="ace-icon fa fa-trash-o bigger-120"></i></a>
                                                    </div>
...
function confirmDelete(val='')
{
	if(val!=''){
		var x = confirm("Are you sure you want to delete?");
		 if (x){
		 		window.location.href="<?php echo base_url().'consumer/Del_FAQs/';?>"+val;
 			  //return true;
		 }
		 else{
			return false;

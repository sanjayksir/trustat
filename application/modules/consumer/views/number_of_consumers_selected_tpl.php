        ...
        <ul class="breadcrumb">
          ...
          <li> <i class="ace-icon fa fa-home home-icon"></i> <a href="<?php echo site_url(); ?>">Home</a> </li>
		 				...
		 				<?php 
								...
								$type 				= "Number of Selected Consumers";
								if($this->session->userdata('admin_user_id')>1 || $this->uri->segment(2)=='add_plant_controller' || $this->uri->segment(2)=='number_of_consumers_selected'){
									$type 			= "Number of Selected Consumers";
									$urlredirect 	= 'number_of_consumers_selected';
								}
						
								if($this->uri->segment(2)=='number_of_consumers_selected'){
 									$constant 		= "" .$type;
									} elseif ($this->uri->segment(2)=='number_of_consumers_selected') {
										$constant 		= "" .$type;
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-12">
                            ...
                            <div class="row" id="add_edit_div">
                              ...
                              <?php if($this->uri->segment(2)=='number_of_consumers_selected' || $this->uri->segment(2)=='view_consumer_selection_criteria'){
									if($this->uri->segment(2)=='number_of_consumers_selected'){
								  	$this->load->view('number_of_consumers_selected_right_tpl'); 
									} else{  $this->load->view('number_of_consumers_selected_right_tpl'); 
		...
		submitHandler: function(form) {
 		...
 		/*	formData 		= new FormData();
 			...
 			$.ajax({
 				...
 				url: "<?php echo base_url(); ?>consumer/save_number_of_consumers_selected/",
 				data: dataSend,

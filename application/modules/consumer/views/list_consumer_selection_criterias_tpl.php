 						...
 						<div class="row">
							<div class="col-xs-12">
 								<div class="widget-box widget-color-blue">
                                                                  ...
                                                                  <a href="<?php echo base_url('consumer/add_consumer_selection_criteria') ?>" class="btn btn-xs btn-warning" title="Add User">Add <?php echo $label; ?> </a>
                                                                    </div>
                                                                </div>
                            ...
                            <tbody>
                                    ...
                                    if(count($userListing)>0){
										...
										<tr id="show<?php echo $listData['criteria_id']; ?>">
                                           ...
                                           <td><?php echo $listData['promotion_type']; ?></td>
												...
												?>
                                                 ...
                                                 <td>
                                                    ...
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                        ...
                                                        <a href="<?php  echo base_url().'consumer/view_consumer_selection_criteria/'.$listData['criteria_id'];?>" class="btn btn-xs btn-success" target="_blank" title="View"><i class="fa fa-eye"></i></a>
                                                         <?php echo anchor("consumer/edit_consumer_selection_criteria/" . $listData['criteria_id'], '<i class="ace-icon fa fa-pencil bigger-130"></i>', array('class' => 'btn btn-xs btn-info','title'=>'Edit')); ?>

      ...
      <h4 class="widget-title">Edit <?php echo $type;?></h4>
		...
		<div class="form-group row">
			...
			<select  name="consumer_age_option" id="consumer_age_option" class="form-control" required>
			 ...
			 <option value="AnyAge"  <?php echo ($get_user_details[0]['consumer_age_option']=='AnyAge')?'selected':'';?>>Any Age</option>
<option value="SpecifyAge"  <?php echo ($get_user_details[0]['consumer_age_option']=='SpecifyAge')?'selected':'';?>>Specify Age</option>
	...
	<div class="form-group row">			
		...
		<div class="form-group row">			
           ...
           <option value="">-Spouse Height Inches-</option>	  
			...
			<div class="col-sm-4">
			  <label fo<input type="hidden" name="field_165" value="all"> 
	ect  name="spouse_weight_kg" id="spouse_weight_kg" class="form-control" required>
		...
		<?php if(Check_Selection_Criteria_Exists('field_1')==true){?> <div class="col-sm-4">
           ...
           <option value="">-<?php echo getConsumerFieldName('field_1'); ?>-</option>	  
			...
			<?php } else { ?> <input type="hidden" name="field_1" value="all">  <?php  } ?>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_2'); ?>-</option>	 
			<option value="<?php echo $get_user_details[0]['field_2'];?>" selected><?php echo $get_user_details[0]['field_2'];?></option>
			<option value="all" selected>All</option>		   
           ...
           <option value="">-<?php echo getConsumerFieldName('field_3'); ?>-</option>	   
			...
			<?php } else { ?> <input type="hidden" name="field_3" value="all">  <?php  } ?>	 		
			</div> 
			<?php } else { ?>    <input type="hidden" name="field_1" value="all">
								 <input type="hidden" name="field_2" value="all">
		...
		<?php if((Check_Selection_Criteria_Exists('field_19')==true)||(Check_Selection_Criteria_Exists('field_20')==true)||(Check_Selection_Criteria_Exists('field_21')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_20'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_20'];?>" selected><?php echo $get_user_details[0]['field_20'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_21'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_21'];?>" selected><?php echo $get_user_details[0]['field_21'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_22')==true)||(Check_Selection_Criteria_Exists('field_23')==true)||(Check_Selection_Criteria_Exists('field_24')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_22'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_22'];?>" selected><?php echo $get_user_details[0]['field_22'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_23'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_23'];?>" selected><?php echo $get_user_details[0]['field_23'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_24'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_24'];?>" selected><?php echo $get_user_details[0]['field_24'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_25')==true)||(Check_Selection_Criteria_Exists('field_26')==true)||(Check_Selection_Criteria_Exists('field_27')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_25'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_25'];?>" selected><?php echo $get_user_details[0]['field_25'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_26'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_26'];?>" selected><?php echo $get_user_details[0]['field_26'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_27'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_27'];?>" selected><?php echo $get_user_details[0]['field_27'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_28')==true)||(Check_Selection_Criteria_Exists('field_29')==true)||(Check_Selection_Criteria_Exists('field_30')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_28'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_28'];?>" selected><?php echo $get_user_details[0]['field_28'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_29'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_29'];?>" selected><?php echo $get_user_details[0]['field_29'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_30'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_30'];?>" selected><?php echo $get_user_details[0]['field_30'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_31')==true)||(Check_Selection_Criteria_Exists('field_32')==true)||(Check_Selection_Criteria_Exists('field_33')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_31'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_31'];?>" selected><?php echo $get_user_details[0]['field_31'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_32'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_32'];?>" selected><?php echo $get_user_details[0]['field_32'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_33'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_33'];?>" selected><?php echo $get_user_details[0]['field_33'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_34')==true)||(Check_Selection_Criteria_Exists('field_35')==true)||(Check_Selection_Criteria_Exists('field_36')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_34'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_34'];?>" selected><?php echo $get_user_details[0]['field_34'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_35'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_35'];?>" selected><?php echo $get_user_details[0]['field_35'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_36'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_36'];?>" selected><?php echo $get_user_details[0]['field_36'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_37')==true)||(Check_Selection_Criteria_Exists('field_38')==true)||(Check_Selection_Criteria_Exists('field_39')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_37'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_37'];?>" selected><?php echo $get_user_details[0]['field_37'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_38'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_38'];?>" selected><?php echo $get_user_details[0]['field_38'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_39'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_39'];?>" selected><?php echo $get_user_details[0]['field_39'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_40')==true)||(Check_Selection_Criteria_Exists('field_41')==true)||(Check_Selection_Criteria_Exists('field_42')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_40'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_40'];?>" selected><?php echo $get_user_details[0]['field_40'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_41'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_41'];?>" selected><?php echo $get_user_details[0]['field_41'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_42'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_42'];?>" selected><?php echo $get_user_details[0]['field_42'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_43')==true)||(Check_Selection_Criteria_Exists('field_44')==true)||(Check_Selection_Criteria_Exists('field_45')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_43'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_43'];?>" selected><?php echo $get_user_details[0]['field_43'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_44'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_44'];?>" selected><?php echo $get_user_details[0]['field_44'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_45'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_45'];?>" selected><?php echo $get_user_details[0]['field_45'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_46')==true)||(Check_Selection_Criteria_Exists('field_47')==true)||(Check_Selection_Criteria_Exists('field_48')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_46'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_46'];?>" selected><?php echo $get_user_details[0]['field_46'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_47'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_47'];?>" selected><?php echo $get_user_details[0]['field_47'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_48'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_48'];?>" selected><?php echo $get_user_details[0]['field_48'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_49')==true)||(Check_Selection_Criteria_Exists('field_50')==true)||(Check_Selection_Criteria_Exists('field_51')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_49'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_49'];?>" selected><?php echo $get_user_details[0]['field_49'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_50'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_50'];?>" selected><?php echo $get_user_details[0]['field_50'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_51'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_51'];?>" selected><?php echo $get_user_details[0]['field_51'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_52')==true)||(Check_Selection_Criteria_Exists('field_53')==true)||(Check_Selection_Criteria_Exists('field_54')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_52'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_52'];?>" selected><?php echo $get_user_details[0]['field_52'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_53'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_53'];?>" selected><?php echo $get_user_details[0]['field_53'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_54'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_54'];?>" selected><?php echo $get_user_details[0]['field_54'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_55')==true)||(Check_Selection_Criteria_Exists('field_56')==true)||(Check_Selection_Criteria_Exists('field_57')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_55'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_55'];?>" selected><?php echo $get_user_details[0]['field_55'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_56'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_56'];?>" selected><?php echo $get_user_details[0]['field_56'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_57'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_57'];?>" selected><?php echo $get_user_details[0]['field_57'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_58')==true)||(Check_Selection_Criteria_Exists('field_59')==true)||(Check_Selection_Criteria_Exists('field_60')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_58'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_58'];?>" selected><?php echo $get_user_details[0]['field_58'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_59'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_59'];?>" selected><?php echo $get_user_details[0]['field_59'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_60'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_60'];?>" selected><?php echo $get_user_details[0]['field_60'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_61')==true)||(Check_Selection_Criteria_Exists('field_62')==true)||(Check_Selection_Criteria_Exists('field_63')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_61'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_61'];?>" selected><?php echo $get_user_details[0]['field_61'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_62'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_62'];?>" selected><?php echo $get_user_details[0]['field_62'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_63'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_63'];?>" selected><?php echo $get_user_details[0]['field_63'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_64')==true)||(Check_Selection_Criteria_Exists('field_65')==true)||(Check_Selection_Criteria_Exists('field_66')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_64'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_64'];?>" selected><?php echo $get_user_details[0]['field_64'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_65'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_65'];?>" selected><?php echo $get_user_details[0]['field_65'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_66'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_66'];?>" selected><?php echo $get_user_details[0]['field_66'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_67')==true)||(Check_Selection_Criteria_Exists('field_68')==true)||(Check_Selection_Criteria_Exists('field_69')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_67'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_67'];?>" selected><?php echo $get_user_details[0]['field_67'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_68'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_68'];?>" selected><?php echo $get_user_details[0]['field_68'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_69'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_69'];?>" selected><?php echo $get_user_details[0]['field_69'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_70')==true)||(Check_Selection_Criteria_Exists('field_71')==true)||(Check_Selection_Criteria_Exists('field_72')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_70'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_70'];?>" selected><?php echo $get_user_details[0]['field_70'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_71'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_71'];?>" selected><?php echo $get_user_details[0]['field_71'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_72'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_72'];?>" selected><?php echo $get_user_details[0]['field_72'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_73')==true)||(Check_Selection_Criteria_Exists('field_74')==true)||(Check_Selection_Criteria_Exists('field_75')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_73'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_73'];?>" selected><?php echo $get_user_details[0]['field_73'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_74'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_74'];?>" selected><?php echo $get_user_details[0]['field_74'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_75'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_75'];?>" selected><?php echo $get_user_details[0]['field_75'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_76')==true)||(Check_Selection_Criteria_Exists('field_77')==true)||(Check_Selection_Criteria_Exists('field_78')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_76'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_76'];?>" selected><?php echo $get_user_details[0]['field_76'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_77'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_77'];?>" selected><?php echo $get_user_details[0]['field_77'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_78'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_78'];?>" selected><?php echo $get_user_details[0]['field_78'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_79')==true)||(Check_Selection_Criteria_Exists('field_80')==true)||(Check_Selection_Criteria_Exists('field_81')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_79'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_79'];?>" selected><?php echo $get_user_details[0]['field_79'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_80'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_80'];?>" selected><?php echo $get_user_details[0]['field_80'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_81'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_81'];?>" selected><?php echo $get_user_details[0]['field_81'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_82')==true)||(Check_Selection_Criteria_Exists('field_83')==true)||(Check_Selection_Criteria_Exists('field_84')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_82'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_82'];?>" selected><?php echo $get_user_details[0]['field_82'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_83'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_83'];?>" selected><?php echo $get_user_details[0]['field_83'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_84'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_84'];?>" selected><?php echo $get_user_details[0]['field_84'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_85')==true)||(Check_Selection_Criteria_Exists('field_86')==true)||(Check_Selection_Criteria_Exists('field_87')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_85'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_85'];?>" selected><?php echo $get_user_details[0]['field_85'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_86'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_86'];?>" selected><?php echo $get_user_details[0]['field_86'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_87'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_87'];?>" selected><?php echo $get_user_details[0]['field_87'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_88')==true)||(Check_Selection_Criteria_Exists('field_89')==true)||(Check_Selection_Criteria_Exists('field_90')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_88'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_88'];?>" selected><?php echo $get_user_details[0]['field_88'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_89'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_89'];?>" selected><?php echo $get_user_details[0]['field_89'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_90'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_90'];?>" selected><?php echo $get_user_details[0]['field_90'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_91')==true)||(Check_Selection_Criteria_Exists('field_92')==true)||(Check_Selection_Criteria_Exists('field_93')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_91'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_91'];?>" selected><?php echo $get_user_details[0]['field_91'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_92'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_92'];?>" selected><?php echo $get_user_details[0]['field_92'];?></option><option value="all" selected>All</option>		   
           ...
           <option value="">-<?php echo getConsumerFieldName('field_93'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_93'];?>" selected><?php echo $get_user_details[0]['field_93'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_94')==true)||(Check_Selection_Criteria_Exists('field_95')==true)||(Check_Selection_Criteria_Exists('field_96')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_94'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_94'];?>" selected><?php echo $get_user_details[0]['field_94'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_95'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_95'];?>" selected><?php echo $get_user_details[0]['field_95'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_96'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_96'];?>" selected><?php echo $get_user_details[0]['field_96'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_97')==true)||(Check_Selection_Criteria_Exists('field_98')==true)||(Check_Selection_Criteria_Exists('field_99')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_97'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_97'];?>" selected><?php echo $get_user_details[0]['field_97'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_98'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_98'];?>" selected><?php echo $get_user_details[0]['field_98'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_99'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_99'];?>" selected><?php echo $get_user_details[0]['field_99'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_100')==true)||(Check_Selection_Criteria_Exists('field_101')==true)||(Check_Selection_Criteria_Exists('field_102')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_100'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_100'];?>" selected><?php echo $get_user_details[0]['field_100'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_101'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_101'];?>" selected><?php echo $get_user_details[0]['field_101'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_102'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_102'];?>" selected><?php echo $get_user_details[0]['field_102'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_103')==true)||(Check_Selection_Criteria_Exists('field_104')==true)||(Check_Selection_Criteria_Exists('field_105')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_103'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_103'];?>" selected><?php echo $get_user_details[0]['field_103'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_104'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_104'];?>" selected><?php echo $get_user_details[0]['field_104'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_105'); ?>-</option>	 
			<option value="<?php echo $get_user_details[0]['field_105'];?>" selected><?php echo $get_user_details[0]['field_105'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_106')==true)||(Check_Selection_Criteria_Exists('field_107')==true)||(Check_Selection_Criteria_Exists('field_108')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_106'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_106'];?>" selected><?php echo $get_user_details[0]['field_106'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_107'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_107'];?>" selected><?php echo $get_user_details[0]['field_107'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_108'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_108'];?>" selected><?php echo $get_user_details[0]['field_108'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_109')==true)||(Check_Selection_Criteria_Exists('field_110')==true)||(Check_Selection_Criteria_Exists('field_111')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_109'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_109'];?>" selected><?php echo $get_user_details[0]['field_109'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_110'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_110'];?>" selected><?php echo $get_user_details[0]['field_110'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_111'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_111'];?>" selected><?php echo $get_user_details[0]['field_111'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_112')==true)||(Check_Selection_Criteria_Exists('field_113')==true)||(Check_Selection_Criteria_Exists('field_114')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_112'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_112'];?>" selected><?php echo $get_user_details[0]['field_112'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_113'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_113'];?>" selected><?php echo $get_user_details[0]['field_113'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_114'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_114'];?>" selected><?php echo $get_user_details[0]['field_114'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_115')==true)||(Check_Selection_Criteria_Exists('field_116')==true)||(Check_Selection_Criteria_Exists('field_117')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_115'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_115'];?>" selected><?php echo $get_user_details[0]['field_115'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_116'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_116'];?>" selected><?php echo $get_user_details[0]['field_116'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_117'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_117'];?>" selected><?php echo $get_user_details[0]['field_117'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_118')==true)||(Check_Selection_Criteria_Exists('field_119')==true)||(Check_Selection_Criteria_Exists('field_120')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_118'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_118'];?>" selected><?php echo $get_user_details[0]['field_118'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_119'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_119'];?>" selected><?php echo $get_user_details[0]['field_119'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_120'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_120'];?>" selected><?php echo $get_user_details[0]['field_120'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_121')==true)||(Check_Selection_Criteria_Exists('field_122')==true)||(Check_Selection_Criteria_Exists('field_123')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_121'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_121'];?>" selected><?php echo $get_user_details[0]['field_121'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_122'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_122'];?>" selected><?php echo $get_user_details[0]['field_122'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_123'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_123'];?>" selected><?php echo $get_user_details[0]['field_123'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_124')==true)||(Check_Selection_Criteria_Exists('field_125')==true)||(Check_Selection_Criteria_Exists('field_126')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_124'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_124'];?>" selected><?php echo $get_user_details[0]['field_124'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_125'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_125'];?>" selected><?php echo $get_user_details[0]['field_125'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_126'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_126'];?>" selected><?php echo $get_user_details[0]['field_126'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_127')==true)||(Check_Selection_Criteria_Exists('field_128')==true)||(Check_Selection_Criteria_Exists('field_129')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_127'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_127'];?>" selected><?php echo $get_user_details[0]['field_127'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_128'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_128'];?>" selected><?php echo $get_user_details[0]['field_128'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_129'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_129'];?>" selected><?php echo $get_user_details[0]['field_129'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_130')==true)||(Check_Selection_Criteria_Exists('field_131')==true)||(Check_Selection_Criteria_Exists('field_132')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_130'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_130'];?>" selected><?php echo $get_user_details[0]['field_130'];?></option><option value="all" selected>All</option>		   
           ...
           <option value="">-<?php echo getConsumerFieldName('field_131'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_131'];?>" selected><?php echo $get_user_details[0]['field_131'];?></option><option value="all" selected>All</option>		   
           ...
           <option value="">-<?php echo getConsumerFieldName('field_132'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_132'];?>" selected><?php echo $get_user_details[0]['field_132'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_133')==true)||(Check_Selection_Criteria_Exists('field_134')==true)||(Check_Selection_Criteria_Exists('field_135')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_133'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_133'];?>" selected><?php echo $get_user_details[0]['field_133'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_134'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_134'];?>" selected><?php echo $get_user_details[0]['field_134'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_135'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_135'];?>" selected><?php echo $get_user_details[0]['field_135'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_136')==true)||(Check_Selection_Criteria_Exists('field_137')==true)||(Check_Selection_Criteria_Exists('field_138')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_136'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_136'];?>" selected><?php echo $get_user_details[0]['field_136'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_137'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_137'];?>" selected><?php echo $get_user_details[0]['field_137'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_138'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_138'];?>" selected><?php echo $get_user_details[0]['field_138'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_139')==true)||(Check_Selection_Criteria_Exists('field_140')==true)||(Check_Selection_Criteria_Exists('field_142')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_139'); ?>-</option>	  
			<option value="<?php echo $get_user_details[0]['field_139'];?>" selected><?php echo $get_user_details[0]['field_139'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_140'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_140'];?>" selected><?php echo $get_user_details[0]['field_140'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_141'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_141'];?>" selected><?php echo $get_user_details[0]['field_141'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_142')==true)||(Check_Selection_Criteria_Exists('field_143')==true)||(Check_Selection_Criteria_Exists('field_144')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_142'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_142'];?>" selected><?php echo $get_user_details[0]['field_142'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_143'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_143'];?>" selected><?php echo $get_user_details[0]['field_143'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_144'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_144'];?>" selected><?php echo $get_user_details[0]['field_144'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_145')==true)||(Check_Selection_Criteria_Exists('field_146')==true)||(Check_Selection_Criteria_Exists('field_147')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_145'); ?>-</option>	 
			<option value="<?php echo $get_user_details[0]['field_145'];?>" selected><?php echo $get_user_details[0]['field_145'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_146'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_146'];?>" selected><?php echo $get_user_details[0]['field_146'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_147'); ?>-</option>	 
			<option value="<?php echo $get_user_details[0]['field_147'];?>" selected><?php echo $get_user_details[0]['field_147'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_148')==true)||(Check_Selection_Criteria_Exists('field_149')==true)||(Check_Selection_Criteria_Exists('field_150')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_148'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_148'];?>" selected><?php echo $get_user_details[0]['field_148'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_149'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_149'];?>" selected><?php echo $get_user_details[0]['field_149'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_150'); ?>-</option>	 
			<option value="<?php echo $get_user_details[0]['field_150'];?>" selected><?php echo $get_user_details[0]['field_150'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_151')==true)||(Check_Selection_Criteria_Exists('field_152')==true)||(Check_Selection_Criteria_Exists('field_153')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_151'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_151'];?>" selected><?php echo $get_user_details[0]['field_151'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_152'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_152'];?>" selected><?php echo $get_user_details[0]['field_152'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_153'); ?>-</option>	 
			<option value="<?php echo $get_user_details[0]['field_153'];?>" selected><?php echo $get_user_details[0]['field_153'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_154')==true)||(Check_Selection_Criteria_Exists('field_155')==true)||(Check_Selection_Criteria_Exists('field_156')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_154'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_154'];?>" selected><?php echo $get_user_details[0]['field_154'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_155'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_155'];?>" selected><?php echo $get_user_details[0]['field_155'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_156'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_156'];?>" selected><?php echo $get_user_details[0]['field_156'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_157')==true)||(Check_Selection_Criteria_Exists('field_158')==true)||(Check_Selection_Criteria_Exists('field_159')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_157'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_157'];?>" selected><?php echo $get_user_details[0]['field_157'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_158'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_158'];?>" selected><?php echo $get_user_details[0]['field_158'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_159'); ?>-</option>	 
			<option value="<?php echo $get_user_details[0]['field_159'];?>" selected><?php echo $get_user_details[0]['field_159'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_160')==true)||(Check_Selection_Criteria_Exists('field_161')==true)||(Check_Selection_Criteria_Exists('field_162')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_160'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_160'];?>" selected><?php echo $get_user_details[0]['field_160'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_161'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_161'];?>" selected><?php echo $get_user_details[0]['field_161'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_162'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_162'];?>" selected><?php echo $get_user_details[0]['field_162'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_163')==true)||(Check_Selection_Criteria_Exists('field_164')==true)||(Check_Selection_Criteria_Exists('field_165')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_163'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_163'];?>" selected><?php echo $get_user_details[0]['field_163'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_164'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_164'];?>" selected><?php echo $get_user_details[0]['field_164'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_165'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_165'];?>" selected><?php echo $get_user_details[0]['field_165'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_166')==true)||(Check_Selection_Criteria_Exists('field_167')==true)||(Check_Selection_Criteria_Exists('field_168')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_166'); ?>-</option>	 
			<option value="<?php echo $get_user_details[0]['field_166'];?>" selected><?php echo $get_user_details[0]['field_166'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_167'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_167'];?>" selected><?php echo $get_user_details[0]['field_167'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_168'); ?>-</option>	 
			<option value="<?php echo $get_user_details[0]['field_168'];?>" selected><?php echo $get_user_details[0]['field_168'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_169')==true)||(Check_Selection_Criteria_Exists('field_170')==true)||(Check_Selection_Criteria_Exists('field_171')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_169'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_169'];?>" selected><?php echo $get_user_details[0]['field_169'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_170'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_170'];?>" selected><?php echo $get_user_details[0]['field_170'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_171'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_171'];?>" selected><?php echo $get_user_details[0]['field_171'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_172')==true)||(Check_Selection_Criteria_Exists('field_173')==true)||(Check_Selection_Criteria_Exists('field_174')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_172'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_172'];?>" selected><?php echo $get_user_details[0]['field_172'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_173'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_173'];?>" selected><?php echo $get_user_details[0]['field_173'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_174'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_174'];?>" selected><?php echo $get_user_details[0]['field_174'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_175')==true)||(Check_Selection_Criteria_Exists('field_176')==true)||(Check_Selection_Criteria_Exists('field_177')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_175'); ?>-</option>	  
			<option value="<?php echo $get_user_details[0]['field_175'];?>" selected><?php echo $get_user_details[0]['field_175'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_176'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_176'];?>" selected><?php echo $get_user_details[0]['field_176'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_177'); ?>-</option>	 
			<option value="<?php echo $get_user_details[0]['field_177'];?>" selected><?php echo $get_user_details[0]['field_177'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_178')==true)||(Check_Selection_Criteria_Exists('field_179')==true)||(Check_Selection_Criteria_Exists('field_180')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_178'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_178'];?>" selected><?php echo $get_user_details[0]['field_178'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_179'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_179'];?>" selected><?php echo $get_user_details[0]['field_179'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_180'); ?>-</option>		
			<option value="<?php echo $get_user_details[0]['field_180'];?>" selected><?php echo $get_user_details[0]['field_180'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_181')==true)||(Check_Selection_Criteria_Exists('field_182')==true)||(Check_Selection_Criteria_Exists('field_183')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_181'); ?>-</option>	  
			<option value="<?php echo $get_user_details[0]['field_181'];?>" selected><?php echo $get_user_details[0]['field_181'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_182'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_182'];?>" selected><?php echo $get_user_details[0]['field_182'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_183'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_183'];?>" selected><?php echo $get_user_details[0]['field_183'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_184')==true)||(Check_Selection_Criteria_Exists('field_185')==true)||(Check_Selection_Criteria_Exists('field_186')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_184'); ?>-</option>	 
			<option value="<?php echo $get_user_details[0]['field_184'];?>" selected><?php echo $get_user_details[0]['field_184'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_185'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_185'];?>" selected><?php echo $get_user_details[0]['field_185'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_186'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_186'];?>" selected><?php echo $get_user_details[0]['field_186'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_187')==true)||(Check_Selection_Criteria_Exists('field_188')==true)||(Check_Selection_Criteria_Exists('field_189')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_187'); ?>-</option>	 
			<option value="<?php echo $get_user_details[0]['field_187'];?>" selected><?php echo $get_user_details[0]['field_187'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_188'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_188'];?>" selected><?php echo $get_user_details[0]['field_188'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_189'); ?>field_189-</option>	
			<option value="<?php echo $get_user_details[0]['field_189'];?>" selected><?php echo $get_user_details[0]['field_189'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_190')==true)||(Check_Selection_Criteria_Exists('field_191')==true)||(Check_Selection_Criteria_Exists('field_192')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_190'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_190'];?>" selected><?php echo $get_user_details[0]['field_190'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_191'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_191'];?>" selected><?php echo $get_user_details[0]['field_191'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_192'); ?>-</option>	 
			<option value="<?php echo $get_user_details[0]['field_192'];?>" selected><?php echo $get_user_details[0]['field_192'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_193')==true)||(Check_Selection_Criteria_Exists('field_194')==true)||(Check_Selection_Criteria_Exists('field_195')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_193'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_193'];?>" selected><?php echo $get_user_details[0]['field_193'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_194'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_194'];?>" selected><?php echo $get_user_details[0]['field_194'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_195'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_195'];?>" selected><?php echo $get_user_details[0]['field_195'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_196')==true)||(Check_Selection_Criteria_Exists('field_197')==true)||(Check_Selection_Criteria_Exists('field_198')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_196'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_196'];?>" selected><?php echo $get_user_details[0]['field_196'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_197'); ?>-</option>
			<option value="<?php echo $get_user_details[0]['field_197'];?>" selected><?php echo $get_user_details[0]['field_197'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_198'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_198'];?>" selected><?php echo $get_user_details[0]['field_198'];?></option><option value="all" selected>All</option>
		...
		<?php if((Check_Selection_Criteria_Exists('field_199')==true)||(Check_Selection_Criteria_Exists('field_200')==true)||(Check_Selection_Criteria_Exists('field_201')==true)){ ?> <div class="form-group row">			
           ...
           <option value="">-<?php echo getConsumerFieldName('field_199'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_199'];?>" selected><?php echo $get_user_details[0]['field_199'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_200'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_200'];?>" selected><?php echo $get_user_details[0]['field_200'];?></option><option value="all" selected>All</option>
           ...
           <option value="">-<?php echo getConsumerFieldName('field_201'); ?>-</option>	
			<option value="<?php echo $get_user_details[0]['field_201'];?>" selected><?php echo $get_user_details[0]['field_201'];?></option><option value="all" selected>All</option>

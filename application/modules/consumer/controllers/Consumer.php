 ...
 class Consumer extends MX_Controller {
	...
	public function number_of_consumers_selected() {
		...
		$unique_system_selection_criteria_id = $this->uri->segment(3);
		 ...
		 $data['get_user_details'] = $this->Consumer_model->get_consumer_selection_criteria_details($unique_system_selection_criteria_id);
		
        $this->load->view('number_of_consumers_selected_tpl', $data);
    }  

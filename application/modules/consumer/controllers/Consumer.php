<?php
 ...
 public function list_consumer_profile_attributes() {
	...
	public function checkProfileAttribute() {
        ...
        $cpmid = $this->input->post('cpm_id');
        $Profile_Attribute = $this->input->post('attribute_name');
        $isExists = $this->Consumer_model->checkProfileAttribute($Profile_Attribute, $user_id, $cpmid);
        echo $isExists;
        exit;
    }

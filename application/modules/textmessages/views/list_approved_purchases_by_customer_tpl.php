        ...
        <div class="main-content-inner">
            ...
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                ...
                <ul class="breadcrumb">
                    ...
                    <li class="active">Customer's Approved Purchases</li>
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="widget-box widget-color-blue">
                            <div class="widget-header widget-header-flat">
                                <h5 class="widget-title bigger lighter">List of Customer's Approved Purchases  <?php //echo $this->uri->segment(3); ?>
								 <?php 
                                ...
                                <div class="widget-toolbar">
								 <a href="<?php echo base_url('/product/list_customer_loyalty_summary') ?>" class="btn btn-xs btn-warning" title="Add Product">Back to Customer Loyalty Mgmt <?php //echo $label; ?> </a>

									...
									<div class="widget-body">
										...
										<div class="widget-main">
											...
											<h4 class="header blue lighter bigger center" style="color:#4a4a4a !important; font-weight:bold;">
												...
												WELCOME TO Admin Panel <br> PLEASE LOGIN OR REGISTER
											...
											<form name="spidey_login" id="spidey_login" action="<?php echo base_url().'buzzbackendadmn/getLoggedIn';?>" method="post" onSubmit="return validateLogin();">
									...
									<div class="widget-body">
										...
										<div class="widget-main">
											...
											<?php
 												...
 												echo "</div>";
 											?>
											<form name="registration" id="registration" action="<?php echo base_url().'buzzbackendadmn/user_registration';?>" method="post" onSubmit="return validateUser();">

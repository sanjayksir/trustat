              ...
              <tr>
                ...
                <td width="15%">
                  <div class="hidden-sm hidden-xs btn-group"> 
                    ...
                    <a href="<?php echo base_url();?>buzzadmn/editorial/editStoryIdea/<?php echo $val['id'];?>"  data-toggle="tooltip" title="Edit Buzz Story" class="btn btn-xs btn-warning" ><i class="ace-icon fa fa-pencil bigger-120 tooltip-success" data-rel="tooltip" ></i> </a>
                    <a class="btn btn-xs btn-danger del_atert" href="javascript:void(0);" onclick="return deleteAlert('<?php echo $val['id'];?>');" title="Delete Idea"><i class="ace-icon fa fa-times red2 bigger-120 tooltip-success" data-rel="tooltip"></i></a>
                  </div>
                </td>
              </tr>
              <?php       }

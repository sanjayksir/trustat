...
<?php $this->load->view('../includes/admin_sidebar'); 
	...
	$label 	= "Saved Story Idea";
 	if(strtolower($this->uri->segment(2))=='editorial' && $this->uri->segment(3)=='listing'){
          ...
          <table class="table table-striped table-bordered table-hover display">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><div class="hidden-sm hidden-xs btn-group"> <a href="<?php echo base_url();?>buzzadmn/Editorial/editStoryIdea/<?php echo $val['id'];?>" title="Edit Idea" class="btn btn-xs btn-warning" ><i class="ace-icon fa fa-pencil bigger-120 tooltip-success" data-rel="tooltip" ></i> </a> <a class="btn btn-xs btn-danger del_atert" href="javascript:void(0);" onclick="return deleteAlert('<?php echo $val['id'];?>');" title="Delete Idea"><i class="ace-icon fa fa-times red2 bigger-120 tooltip-success" data-rel="tooltip"></i></a>&nbsp;

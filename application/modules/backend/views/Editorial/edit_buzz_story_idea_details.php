    ...
    <div class="main-content">
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    <li> <i class="ace-icon fa fa-home home-icon"></i> <a href="<?php echo base_url(); ?>">Home</a> </li>
                    <li> <a href="#">Editorial</a> </li>
                    <li class="active">Story Buzz Story Details</li>
                </ul>
                <!-- /.breadcrumb -->
            ...
            <div class="page-content">
                <div class="row">
                    <div class="col-xs-12">
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="header smaller lighter blue">Story Buzz Story Details</h3>
                                    ...
                                    <div class="col-xs-12 col-sm-12">
                                        <div class="widget-box">
                                            <div class="widget-header">
                                                <h4 class="widget-title pull-right padding-right"><a href="<?php echo base_url().'buzzadmn/editorial/buzz_story_listing';?>">Back</a></h4>
                                            </div>
...
$('.my_button').click(function() { 
 ...
 $(document).ready(function(){	
 	var clickedButton = '';
	var url='editBuzzStoryDetail';
	if($("#storyId").val()!=''){
		url='editBuzzStoryDetail';
	}

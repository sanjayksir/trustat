 ...
 <?php $this->load->view('../includes/admin_sidebar');// echo '***<pre>';print_r($storyIdea);?>
    ...
    <div class="main-content">
       ...
       <img src="<?php echo !empty($product_thumb_images)? site_url($medisUrl.'/'.$product_thumb_images):site_url('assets/images/upload_img.png'); ?>" alt="" title="" data-placeholder="<?php echo site_url('assets/images/upload_img.png'); ?>" />
											...
											<div class="col-sm-2">
                                                <div class="thumbnail">
                                                <a href="<?php echo !empty($product_image)? site_url($medisUrl.'/'.$product_image):"#"; ?>" id="thumb-image" data-toggle="image" class="img-thumbnail" mime-type="image">
       <img src="<?php echo !empty($product_image)? site_url($medisUrl.'/'.$product_image):site_url('assets/images/upload_img.png'); ?>" alt="" title="" data-placeholder="<?php echo site_url('assets/images/upload_img.png'); ?>" />
                                                    <span class="media-info">Product Ad Image</span>
                                                </a>
                                                <input type="hidden" name="product_image" value="<?php echo $product_image; ?>" id="input-image" />
                                                </div>
                                            </div>
											<div class="col-sm-2">
                                                <div class="thumbnail">

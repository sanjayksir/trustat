											...
											<div class="col-xs-12"> 
																	...
																	<div class="col-xs-9 col-sm-9">																	
																	   <video width="200" height="150" controls>
																		  <source src="<?php echo base_url().'uploads/'.$product_survey_video;?>" type="video/mp4">
											...
											<div class="col-xs-12"> 
																	...
																	<div class="col-xs-9 col-sm-9">																	
																	   <audio width="200" height="150" controls>
																		  <source src="<?php echo base_url().'uploads/'.$product_survey_audio;?>" type="audio/mp4">
									...
									<?php if($product_survey_pdf!=''){?>
										<div class="row">	
											<div class="col-xs-12"> 
																	...
																	<div class="col-xs-9 col-sm-9">	
																		<a href="<?php echo base_url().'uploads/'.$product_survey_pdf;?>" target="_blank" /><?php //echo $i;?> <img src="<?php echo base_url();?>/assets/images/pdf-preview.png" alt="<?php echo $recs;?>" width = "200"><br /><?php //echo $recs;?>Please click here to Open the File</a>
																	</div>
  																</div>
															</div>
									<?php } } ?>
									...
									<?php if($product_survey_image!=''){?>
										<div class="row">	
											<div class="col-xs-12"> 
																	...
																	<div class="col-xs-9 col-sm-9">	
																		<img style="border:1px solid grey;"  src="<?php echo base_url().'/uploads/'.$product_survey_image;?>" width="100px" height="100px;" />
																	</div>
  																</div>
															</div>
									<?php } } ?>

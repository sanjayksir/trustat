							...
							<div class="col-xs-12">
 								<div class="widget-box widget-color-blue">
                                                                    <div class="widget-header widget-header-flat">
                                                                        <h5 class="widget-title bigger lighter">Download Survey Closure Report, you can also make your selection by dates<?php //echo $label;?> <?php //echo $this->uri->segment(3);?>
																		<div class="widget-toolbar">
													<a href="<?php echo base_url();?>surveys/view_survey_response_by_question_answer/<?php echo $this->uri->segment(3);?>" class="btn btn-xs btn-warning"> Back </a>
																	</div>
																	</h5>
                                                                    </div>

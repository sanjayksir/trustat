	...
	<div class="widget-main">																		
		<div class="form-group row">			
			...
			<!-- <label for="form-field-8"><b>Media</b></label> : <?php echo $promotion_media_type; ?>
										...
										<div class="row">	
											<div class="col-xs-12"> 
																	<div class="col-xs-3 col-sm-3">
																	 	<label><strong>Media : </strong>Product Survey Video</label>
																	</div>
				...
				$qproduct_data 	= getquestionFeedbackDetailsBygetquestionID($listData['product_id'], $listData['consumer_id'], $promotion_id, "product_survey"); 
											$i = 1;
        ...
        $sno =  $page + 1;
								...
								$qproduct_data 	= getquestionFeedbackDetails($listData['product_id'], $listData['consumer_id'], $promotion_id, "product_survey");
										 $i = 0;
										 foreach($qproduct_data as $res){ 
										$i++;

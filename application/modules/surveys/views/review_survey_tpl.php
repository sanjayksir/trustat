        ...
        <div class="main-content-inner">
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Review Survey Details</li>
                </ul>
            ...
            <div class="page-content">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <div class="row">
                            <div class="col-xs-12">
                                <h3 class="header smaller lighter blue">Review Survey Details</h3>
                                    ...
                                    <div class="col-xs-12 col-sm-12">
                                        <div class="widget-box">
                                            <div class="widget-header">
                                                <h4 class="widget-title pull-right padding-right" style="padding-right:10px;"><a href="<?php echo base_url().'surveys/launch_survey'; ?>">Back</a></h4>
                                            </div>
            ...
            <div class="row">
              <div class="col-xs-12" style="margin-left:25px"> 
					<h4 class="widget-title pull-left padding-left" style="padding-right:10px;"><a href="<?php echo base_url().'product/ask_survey_feedback/' . $this->uri->segment(3); ?>">Click here to see the list for the questions</a></h4>

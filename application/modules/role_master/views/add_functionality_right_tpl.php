    ...
    <div id="ajax_msg"></div>
      ...
      <form name="user_frm" id="user_frm" action="#" method="POST">
		...
		<select  name="attribute_type_slug" id="attribute_type_slug" class="form-control" required>
			...
			function sync()
			{
			  var functionality_name_value = document.getElementById('functionality_name_value');
			  //new_text = text.replace(' ', '_');
			  var functionality_name_slug = document.getElementById('functionality_name_slug');
			  functionality_name_slug.value = functionality_name_value.value.split(' ').join('_').toLowerCase();
			}
			</script>
			<div class="col-sm-4">
			  <label for="form-field-8">Functionality Name</label>
			  <input type="text" placeholder="Please Enter Functionality Name" name="functionality_name_value" id="functionality_name_value"  onkeyup="sync()" class="form-control" required>			  
			</div>
			
			<div class="col-sm-4">
			  <label for="form-field-8">Functionality Slug</label>
			  <input type="text" placeholder="Please Enter Functionality Slug" name="functionality_name_slug" id="functionality_name_slug" class="form-control" readonly>			  
			</div>

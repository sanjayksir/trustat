 						...
 						<div class="row">
							<div class="col-xs-12">
 								<div class="widget-box widget-color-blue">
                                                                 ...
                                                                 <a href="<?php echo base_url('role_master/add_functionality') ?>" class="btn btn-xs btn-warning" title="Add User">Add a New Functionality <?php // echo $label; ?> </a><!-- | <a href="<?php echo base_url('role_master/list_all_functionalities') ?>" class="btn btn-xs btn-warning" title="Add User">List all Functionalities <?php //echo $label; ?> </a>
                                                                    </div>-->
                                                                </div>
            ...
            <form id="form-filter" action="" method="get" class="form-horizontal" >
                ...
                <div class="col-sm-6">
                    <div class="input-group">
                        <input type="text" name="search" id="search" value="<?= $this->input->get('search',null); ?>" class="form-control search-query" placeholder="Functionality ID, Name, Slug">
                            ...
                            <tbody>
                                    ...
                                    if(count($userListing)>0){
										...
										<tr id="show<?php echo $listData['cpm_id']; ?>">
                                           ...
                                           <td><?php echo $listData['functionality_name_value']; ?></td>
                                           <td><?php echo $listData['functionality_name_slug']; ?></td>
                                                 ...
                                                 <td>
                                                    ...
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                       ...
                                                       <!-- <a href="<?php //echo base_url().'consumer/view_consumer_profile_attribute/'.$listData['cpm_id'];?>" class="btn btn-xs btn-success" target="_blank" title="View"><i class="fa fa-eye"></i></a>-->
                                                         <?php echo anchor("role_master/edit_functionality/" . $listData['id'], '<i class="ace-icon fa fa-pencil bigger-130"></i>', array('class' => 'btn btn-xs btn-info','title'=>'Edit Functionality')); ?>
														 <!--

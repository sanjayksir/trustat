...
<?php $this->load->view('../includes/admin_top_navigation');?>
	<div class="main-container ace-save-state" id="main-container">
			...
			if($this->session->userdata('admin_user_id')==1){
				$label = 'Auto Email MIS configuration Management';
			}else{
				$label = 'Auto Email MIS configuration Management';
			}
			?>
 						...
 						<div class="row">
							<div class="col-xs-12">
 								<div class="widget-box widget-color-blue">
                                                                 ...
                                                                 <a href="<?php echo base_url('role_master/add_auto_email_mis_master') ?>" class="btn btn-xs btn-warning" title="Add User">Add a New Auto Email MIS Master <?php // echo $label; ?> </a><!-- | <a href="<?php echo base_url('role_master/list_all_functionalities') ?>" class="btn btn-xs btn-warning" title="Add User">List all Functionalities <?php //echo $label; ?> </a> -->
                                                                    </div>
                                                                </div>
            ...
            <form id="form-filter" action="" method="get" class="form-horizontal" >
                ...
                <div class="col-sm-6">
                    <div class="input-group">
                        <input type="text" name="search" id="search" value="<?= $this->input->get('search',null); ?>" class="form-control search-query" placeholder="Auto Email MIS Master ID, Name, Slug">
                        ...
                        <table id="missing_people" class="table table-striped table-bordered table-hover">
                            <thead>
                                    <tr>
                                            <th>#</th>
											<th>Auto Email MIS Master ID</th>
                                            <th>Auto Email MIS Master Name</th>
                                            <th>Auto Email MIS Master Slug</th>                                           
                                            <th>Action</th>
                                    </tr>
                            </thead>
                            <tbody>
                                                 ...
                                                 <td>
                                                    ...
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                       ...
                                                       <!-- <a href="<?php //echo base_url().'consumer/view_consumer_profile_attribute/'.$listData['cpm_id'];?>" class="btn btn-xs btn-success" target="_blank" title="View"><i class="fa fa-eye"></i></a>-->
                                                         <?php echo anchor("role_master/edit_auto_email_mis_master/" . $listData['r_id'], '<i class="ace-icon fa fa-pencil bigger-130"></i>', array('class' => 'btn btn-xs btn-info','title'=>'Edit Auto Email MIS Master')); ?>
														 <!--

        ...
        <ul class="breadcrumb">
          ...
          <li> <i class="ace-icon fa fa-home home-icon"></i> <a href="<?php echo site_url(); ?>">Home</a> </li>
		 				...
		 				<?php 
								...
								if($this->uri->segment(2)=='edit_auto_email_mis_master'){
 									$constant 		= "Edit " .$type;
									} elseif ($this->uri->segment(2)=='view_auto_email_mis_master') {
										$constant 		= "View " .$type;
          ...
          <li class="active">Auto Email MIS Master</li><li class="active"><?php echo $constant;?></li>
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-12">
                            ...
                            <div class="row" id="add_edit_div">
                              ...
                              <?php if($this->uri->segment(2)=='edit_auto_email_mis_master' || $this->uri->segment(2)=='view_auto_email_mis_master'){
									if($this->uri->segment(2)=='edit_auto_email_mis_master'){
								  	$this->load->view('edit_auto_email_mis_master_right_tpl'); 
									} else{  $this->load->view('view_auto_email_mis_master_tpl'); 

					 			}

                              }else{  $this->load->view('add_auto_email_mis_master_right_tpl'); 
...
<script>
 ...
 $(document).ready(function(){	
	...
	$("form#user_frm").validate({
		...
		messages: {
				mis_report_name: {
					required: "Please Enter Auto Email MIS Master Name...",
					remote: "This Auto Email MIS Master Name already exists!"
				}, 
		},
		...
		submitHandler: function(form) {
 		...
 		/*	formData 		= new FormData();
 			...
 			$.ajax({
 				...
 				url: "<?php echo base_url(); ?>role_master/save_auto_email_mis_master/",
 				data: dataSend,
				success: function (msg) {
					if(parseInt(msg)==1){
						...
						$('#blah').attr('src', '').hide();
						$('#user_frm')[0].reset(); 
						  window.location.href="<?php echo base_url(); ?>role_master/list_all_auto_email_mis_masters/";						
					}
					else if(parseInt(msg)==2){
						$('#ajax_msg').text("Auto Email MIS Master Already Exists!").css("color","red").show();
  					      window.location.href="<?php echo base_url(); ?>role_master/list_all_auto_email_mis_masters/";						
					}
					else{

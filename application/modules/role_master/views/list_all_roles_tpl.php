							...
							<div class="col-xs-12">
 								<div class="widget-box widget-color-blue">
                                                                 <div class="widget-header widget-header-flat">
                                                                    <h5 class="widget-title bigger lighter">List <?php echo "All Roles";?></h5>
                                                                    <div class="widget-toolbar">
                                                                 <a href="<?php echo base_url('role_master/add_role') ?>" class="btn btn-xs btn-warning" title="Add User">Add a New Role <?php // echo $label; ?> </a> | <a href="<?php echo base_url('role_master/list_all_functionalities') ?>" class="btn btn-xs btn-warning" title="Add User">List all Functionalities <?php //echo $label; ?> </a> 
                                                                    </div>
                                                                </div>
                            ...
                            <tbody>
                                    ...
                                    if(count($userListing)>0){
										...
										<tr id="show<?php echo $listData['cpm_id']; ?>">
                                           ...
                                           <td><?php echo $listData['role_name_slug']; ?></td>
                                                 ...
                                                 <td>
                                                    ...
                                                    <div class="hidden-sm hidden-xs action-buttons">
                                                       ...
                                                       <!-- <a href="<?php //echo base_url().'consumer/view_consumer_profile_attribute/'.$listData['cpm_id'];?>" class="btn btn-xs btn-success" target="_blank" title="View"><i class="fa fa-eye"></i></a>-->
                                                         <?php echo anchor("role_master/edit_role/" . $listData['id'], '<i class="ace-icon fa fa-pencil bigger-130"></i>', array('class' => 'btn btn-xs btn-info','title'=>'Edit')); ?>
														 <!--

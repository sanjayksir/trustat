 						...
 						<div class="row">
							<div class="col-xs-12">
 								<div class="widget-box widget-color-blue">
                                                                 ...
                                                                 <a href="<?php echo base_url('role_master/add_customer_billing_master'); ?>" class="btn btn-xs btn-warning" title="Add a New Customer Billing Customer">Add a New Customer Billing Master <?php // echo $label; ?> </a><!-- | <a href="<?php echo base_url('role_master/list_all_functionalities') ?>" class="btn btn-xs btn-warning" title="Add User">List all Functionalities <?php //echo $label; ?> </a> -->
                                                                    </div>
                                                                </div>
            ...
            <form id="form-filter" action="" method="get" class="form-horizontal" >
                ...
                <div class="col-sm-6">
                    <div class="input-group">
                        <input type="text" name="search" id="search" value="<?= $this->input->get('search',null); ?>" class="form-control search-query" placeholder="Customer Billing Master Name Or Slug">
                        ...
                        <table id="missing_people" class="table table-striped table-bordered table-hover">
                            <thead>
                                    <tr>
                                            <th>#</th>
											<th>Customer Billing Master Name</th>
                                            <th>Customer Billing Master Slug</th>
                                            <th>Created Date</th> 
											<th>Updated Date</th>
                                            <th>Action</th>
                                    </tr>
                            ...
                            <tbody>
                                    ...
                                    if(count($userListing)>0){
										...
										<tr id="show<?php echo $listData['cbpm_id']; ?>">
                                           <td><?php echo $sno;$sno++; ?></td>
										   <td><?php echo $listData['billin_particular_name']; ?></td>
                                           <td><?php echo $listData['billin_particular_slug']; ?></td>
                                           <td><?php echo $listData['date_created']; ?></td>
										   <td><?php echo $listData['date_updated']; ?></td>
                                                 <td><div class="hidden-sm hidden-xs action-buttons" style="width:100px" align="center">
													    <?php echo anchor("role_master/edit_customer_billing_master/" . $listData['cbpm_id'], '<i class="ace-icon fa fa-pencil bigger-130"></i>', array('class' => 'btn btn-xs btn-info','title'=>'Edit Customer Billing Master')); ?>
														 <!--

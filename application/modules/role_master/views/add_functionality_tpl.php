        ...
        <ul class="breadcrumb">
          ...
          <li> <i class="ace-icon fa fa-home home-icon"></i> <a href="<?php echo site_url(); ?>">Home</a> </li>
		 				...
		 				<?php 
								...
								if($this->uri->segment(2)=='edit_functionality'){
 									$constant 		= "Edit " .$type;
									} elseif ($this->uri->segment(2)=='view_functionality') {
										$constant 		= "View " .$type;
          ...
          <li class="active">Functionality</li><li class="active"><?php echo $constant;?></li>
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-12">
                            ...
                            <div class="row" id="add_edit_div">
                              ...
                              <?php if($this->uri->segment(2)=='edit_functionality' || $this->uri->segment(2)=='view_functionality'){
									if($this->uri->segment(2)=='edit_functionality'){
								  	$this->load->view('edit_functionality_right_tpl'); 
									} else{  $this->load->view('view_functionality_tpl'); 

					 			}

                              }else{  $this->load->view('add_functionality_right_tpl'); 
...
<script>
 ...
 $(document).ready(function(){	
	...
	$("form#user_frm").validate({
		rules: {
  			functionality_name_value:{
 						 required: true, 
						 remote: {

                       	 	url: "<?php echo base_url().'role_master/';?>checkFunctionality",
                          	type: "post",
 							data: {  id: $( "#id" ).val() }
                    	 } 
					  },
		...
		messages: {
				functionality_name_value: {
					required: "Please Enter functionality Name...",
					remote: "This functionality Name already exists!"
				}, 
		},
		...
		submitHandler: function(form) {
 		...
 		/*	formData 		= new FormData();
 			...
 			$.ajax({
 				...
 				url: "<?php echo base_url(); ?>role_master/save_functionality/",
 				data: dataSend,
				success: function (msg) {
					if(parseInt(msg)==1){
						...
						$('#blah').attr('src', '').hide();
						$('#user_frm')[0].reset(); 
						  window.location.href="<?php echo base_url(); ?>role_master/list_all_functionalities/";						
					}
					else if(parseInt(msg)==2){
						$('#ajax_msg').text("Functionality Already Exists!").css("color","red").show();
  					      window.location.href="<?php echo base_url(); ?>role_master/list_all_functionalities/";						
					}
					else{

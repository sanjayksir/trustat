 								...
 								<div class="row">
									<div class="col-xs-12">
										<h3 class="header smaller lighter blue">List <?php echo $label;?></h3>
 										<div style="clear:both;height:40px;"><a href="<?php echo base_url()?>plant_master/assign_plant_to_users" class="btn btn-primary pull-right" title="Assign Plant">Assign Plants</a></div>

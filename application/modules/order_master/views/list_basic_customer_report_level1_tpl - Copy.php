						...
						<div class="alert alert-block alert-success" style='display:none;'>
   						...
   						<div class="row">
							<div class="col-xs-12">
 											...
 											<table id="List_Consumer" class="table table-striped table-bordered table-hover">
												...
												<tr>
													...
													<tr>
														...
														<th rowspan="2">	Date and time of scan	</th>
														<th rowspan="2">First Scan (Yes/No)</th>
														<th rowspan="2">	Customer Name 	</th>
														<th rowspan="2">	Customer ID	</th>
														<th rowspan="2">	Product Name	</th>
														<th rowspan="2">	Unique Product Code	</th>
														<th colspan="3" style="text-align:center">	Geolocation of Scan of Level 1	</th>
														<th rowspan="2">	Consumer ID	</th>
														<th rowspan="2">	Last Retail Store Stock under TRACEK	</th>
														<th rowspan="2">	Scanned Product Batch Details	</th>
														<th rowspan="2" style="text-align:center">If Consumer bought the product scanned with same Product ID	</th>
														<th colspan="3" style="text-align:center"> If Consumer bought any product of the Brand </th>
														<th colspan="9" style="text-align:center"> Video Played </th>
														<th colspan="9" style="text-align:center"> Audio Played </th>
														<th colspan="9" style="text-align:center"> PDF Played </th>														
  													</tr>
													<tr>
								...
								?>
											<td><?php echo $listData['f_name']; ?> <?php echo $listData['l_name']; ?></td>
								...
								if($row1['purchased_product_id']!=''){
									?> <td><?php echo "Yes"; ?></td> <?php
									?> <td><?php echo $row1['create_date']; ?></td> <?php
									?> <td><?php echo $row1['product_id']; ?></td> <?php
								...
								if($row2['id']!=''){
								?> <td>	<?php echo "Yes"; ?></td> <?php
								?> <td>	<?php echo $row2['media_play_location']; ?></td> <?php
								?> <td>	<?php echo $row2['watched_complete']; ?></td> <?php								
								}else{
								?> <td>	<?php echo "No"; ?></td> <?php	
								?> <td>	<?php echo ""; ?></td> <?php
								?> <td>	<?php echo ""; ?></td> <?php
								...
								<?php 
								$sql3 = "select id, selected_answer FROM consumer_feedback where product_qr_code = '".$listData['bar_code']."' AND user_id = '".$listData['consumer_id']."' AND media_type = 'Product Video' ORDER BY id ASC";
								...
								if($row3['id']!=''){	
								?> <td>	<?php echo "Yes"; ?></td> <?php								
								?> <td>	<?php echo $row3['selected_answer']; ?></td> <?php
								while($row3s = mysql_fetch_array($result3))
								{
								?> <td><?php echo $row3s['selected_answer']; ?></td> <?php
								}
								...
								if($row5['id']!=''){
								?> <td>	<?php echo "Yes"; ?></td> <?php
								?> <td>	<?php echo $row5['media_play_location']; ?></td> <?php
								?> <td>	<?php echo $row5['watched_complete']; ?></td> <?php								
								}else{
								?> <td>	<?php echo "No"; ?></td> <?php	
								?> <td>	<?php echo ""; ?></td> <?php
								?> <td>	<?php echo ""; ?></td> <?php
								...
								<?php 
								$sql6 = "select id, selected_answer FROM consumer_feedback where product_qr_code = '".$listData['bar_code']."' AND user_id = '".$listData['consumer_id']."' AND media_type = 'Product Audio' ORDER BY id ASC";
								...
								if($row6['id']!=''){	
								?> <td>	<?php echo "Yes"; ?></td> <?php								
								?> <td>	<?php echo $row6['selected_answer']; ?></td> <?php
								while($row6s = mysql_fetch_array($result6))
								{
								?> <td>	<?php echo $row6s['selected_answer']; ?></td> <?php
								}								
								...
								if($row8['id']!=''){
								?> <td>	<?php echo "Yes"; ?></td> <?php
								?> <td>	<?php echo $row8['media_play_location']; ?></td> <?php
								?> <td>	<?php echo $row8['watched_complete']; ?></td> <?php								
								}else{
								?> <td>	<?php echo "No"; ?></td> <?php	
								?> <td>	<?php echo ""; ?></td> <?php
								?> <td>	<?php echo ""; ?></td> <?php
								...
								<?php 
								$sql9 = "select id, selected_answer FROM consumer_feedback where product_qr_code = '".$listData['bar_code']."' AND user_id = '".$listData['consumer_id']."' AND media_type = 'Product PDF' ORDER BY id ASC";
								...
								if($row9['id']!=''){	
								?> <td>	<?php echo "Yes"; ?></td> <?php						
								?> <td>	<?php echo $row9['selected_answer']; ?></td> <?php
								while($row9s = mysql_fetch_array($result9))
								{
								?> <td>	<?php echo $row9s['selected_answer']; ?></td> <?php
								}

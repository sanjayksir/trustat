    ...
    <div class="main-content-inner">
      <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
          ...
          <li class="active">Administration</li><li class="active">Group Permissions</li>
        </ul>
        <!-- /.breadcrumb -->
      ...
      <div class="page-content">
        <div class="row">
          <div class="col-xs-12">
            <div class="row">
              <div class="col-xs-12">
                <h3 class="header smaller lighter blue">Set Group Permissions()</h3>
                <div id="ajax_msg"></div>
                  ...
                  <div class="row">
                    <div class="col-xs-12">
                      <div class="row" id="add_edit_div">
                        ...
                        <?php
						 if($this->uri->segment(3)!='' && $this->uri->segment(2)=='edit_permissions'){
                      		 $this->load->view('edit_group_permissions_right_tpl');
                       	 }else{
							  $this->load->view('group_permissions_right_tpl');
						 }?>
                      </div>
	...
	$("form#frm").validate({
		...
		submitHandler: function(form) {
		  ...
		  $.ajax({
				...
				url: "<?php echo base_url(); ?>myspidey_user_group_permissions/saveData/",

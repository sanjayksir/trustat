...
<!-- /Export to Excel -->
	...
	<div class="main-container ace-save-state" id="main-container">
			...
			<?php $label = 'Overall Global Inventory in Hand Download Transaction Records Only';?>
   						...
   						<div class="row">
							<div class="col-xs-12">
 								<div class="widget-box widget-color-blue">
                                                    ...
                                                    <?php echo anchor('reports/overall_global_inventory_in_hand_tr_records', ' Back ',array('class' => 'btn btn-xs btn-warning')); ?>
																	</div>
                                                                    </div>

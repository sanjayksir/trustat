...
<!-- /Export to Excel -->
	...
	<div class="main-container ace-save-state" id="main-container">
			...
			<?php $label = 'Overall Global Inventory in Hand Transaction Records Only';?>
   						...
   						<div class="row">
							<div class="col-xs-12">
 								<div class="widget-box widget-color-blue">
													...
													echo anchor('reports/overall_global_inventory_in_hand_tr_all_records', 'Go to Archived Report',array('class' => 'btn btn-xs btn-warning'))."|";
													
													echo anchor('reports/overall_global_inventory_in_hand_tr_records_download', 'Go to download report',array('class' => 'btn btn-xs btn-warning'));
													}else{ 													
													echo anchor('reports/overall_global_inventory_in_hand_tr_all_records_download', 'Go to download report',array('class' => 'btn btn-xs btn-warning')); } ?>
																	</div>
                                                                    </div>

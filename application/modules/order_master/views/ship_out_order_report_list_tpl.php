...
<?php $this->load->view('../includes/admin_top_navigation');?>
	<div class="main-container ace-save-state" id="main-container">
			...
			<?php $label = 'Product Shipped Out Order List';?>
                                                                                ...
                                                                                <form id="form-filter" action="" method="get" class="form-horizontal" >
                                                                                    ...
                                                                                    <div class="col-sm-6">
                                                                                        <div class="input-group">
                                                                                            <input type="text" name="search" id="search" value="<?= $this->input->get('search',null); ?>" class="form-control search-query" placeholder="Product Name, Product SKU, Invoice Number, location Type or location Name">
                                        ...
                                        foreach ($ScanedCodeListing as $key=>$listData){
											...
											?>
											   ...
											   <td><?php echo $listData['product_name']; ?></td>
											    <td><?php echo $listData['request_id']; ?></td>
											   <td><?php echo $listData['invoice_number']; ?> <a href="<?php  echo base_url().'reports/ship_out_order_details/'.$listData['invoice_number'];?>" class="btn btn-xs btn-success" target="_blank" title="View Details">View Details <i class="fa fa-eye"></i></a></td>
											    <td><?php if(getRecLocationByInvoiceNumber($listData['invoice_number'])!='0') { 
												echo getRecLocationByInvoiceNumber($listData['invoice_number']); ?>, <?php echo getRecLocationTypeByInvoiceNumber($listData['invoice_number']); 
												} else {

													echo "Item not received yet.";
												}

...
<!-- /Export to Excel -->
	...
	<div class="main-container ace-save-state" id="main-container">
			...
			<?php $label = 'Unpacked Inventory in hand';?>
   						...
   						<div class="row">
							<div class="col-xs-12">
 								<div class="widget-box widget-color-blue">
                                                    ...
                                                    <?php echo anchor('reports/unpacked_inventory_in_hand_download', 'Go to download report',array('class' => 'btn btn-xs btn-warning')); ?>
																	</div>
                                                                    </div>
        ...
        $sno =  $page + 1;
						...
						<td><?php echo anchor("reports/inventory/unpacked_inventory_in_hand_list_codes/".$listData['product_id']."/".$listData['pack_level'], '<i class="ace-icon fa fa-eye bigger-130"> View Codes List</i>', array('class' => 'btn btn-xs btn-info','title'=>'View Codes List'));  ?></td>
                                              </tr>
                                         <?php }
										}else{ ?>

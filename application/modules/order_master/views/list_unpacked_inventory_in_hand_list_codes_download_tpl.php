...
<!-- /Export to Excel -->
	...
	<div class="main-container ace-save-state" id="main-container">
			...
			<?php $label = 'Unpacked Inventory in hand List Codes Download';?>
   						...
   						<div class="row">
							<div class="col-xs-12">
 								<div class="widget-box widget-color-blue">
                                                    ...
                                                    <?php echo anchor('reports/inventory/unpacked_inventory_in_hand_list_codes/'.$this->uri->segment(4).'/'.$this->uri->segment(5), ' Back ',array('class' => 'btn btn-xs btn-warning')); ?>
																	</div>
                                                                    </div>

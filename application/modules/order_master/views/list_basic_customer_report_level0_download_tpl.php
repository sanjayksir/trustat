	...
	<div class="main-container ace-save-state" id="main-container">
							...
							<div class="col-xs-12">
 								<div class="widget-box widget-color-blue">
                                                                    <div class="widget-header widget-header-flat">
                                                                        <h5 class="widget-title bigger lighter">Download Post-Purchase products scan report, you can also make your selection by dates<?php echo $_SERVER['SERVER_NAME']; ?>
												<div class="widget-toolbar">
                                                    <?php echo anchor('reports/barcode/basic_customer_report_level0', ' Back ',array('class' => 'btn btn-xs btn-warning')); ?>
																	</div>						
																		</h5>
                                                          </div>	
		...
		$mnvtext58 = $mnv58_result->message_notification_value; ?>
																			...
																			<option value="<?php echo $mnvtext58; ?>"><?php echo $mnvtext58; ?></option>
                                                                                            <?php //echo Utils::selectOptions2('pagelimit2',['options'=>$this->config->item('pageOption2'),'value'=>$this->config->item('pageLimit2')]) ?>
                                                                                            </select>
                                                                                        Records in a file
                                                                                        </label> 
                                                                                    </div><br />
...
<label style="margin:10px">Select “From Date” and “To Date” to download data relating to the selected period and press “Select dates & Press Here” button. Please note that maximum number of line items in any one excel sheet is limited to [<?php echo $mnvtext58; ?>] records and if line items for data exceed [<?php echo $mnvtext58; ?>], it is automatically split between two or more files.</label><br /><br />						
                              ...
                              <input type="text" name="from_date_data" id="from_date_data" readonly="readonly" value="<?php //echo $dateoneMAgo; ?>" class="form-control" />
                               ...
                               <input type="text" name="to_date_data" id="to_date_data" readonly="readonly" value="<?php //echo $Datetoday; ?>" class="form-control" />
                                  ...
                                  <span class="glyphicon glyphicon-th"></span>
								  			  ...
								  			  <input type="text" name="from_date_data" id="from_date_data" value="<?php //echo $dateoneMAgo; ?>" class="form-control" />
								  <input type="text" name="to_date_data" id="to_date_data" value="<?php //echo $Datetoday; ?>" class="form-control" />
                    -->
					<input type="hidden" name="search" id="search" value="<?= $this->input->get('search',null); ?>" class="form-control search-query" placeholder="Product Name or Bar-QR Code or Consumer ID or Invoice Date">
                      ...
                      <button type="submit" class="btn btn-inverse btn-white" onclick="DateCheck();" style="background-color: rgb(48, 126, 204) !important; color: white !important; margin:10px"><span class="ace-icon icon-on-right bigger-110"></span>Select Dates & Press Here</button>
										...
										<script type="text/javascript">
											//var startDate = '05/22/2015'; //date in dd/mm/yyyy format
											//var endDate = '05/25/2015';											
					...
					<br />																
							...
							<div style="height: 1px; overflow: hidden;">
 								<table id="List_Consumer" class="table table-striped table-bordered table-hover" style="display: block;">
									...
									$sno =  $page + 1;
                                        foreach ($ScanedCodeListing as $key=>$listData){
											...
											<td style="text-align:center"> <?php echo $listData['selling_price']; ?></td><?php //echo base_url(); 								
								...
								<td style="text-align:center"><?php 
								$sql9 = "select id, watched_complete, media_play_location FROM consumer_media_view_details where product_qr_code = '".$listData['bar_code']."' AND consumer_id = '".$listData['consumer_id']."' AND media_type = 'Product Demo Audio' ORDER BY id DESC";

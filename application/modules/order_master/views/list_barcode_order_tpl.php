					...
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
 					...
 					<div class="page-content">
                      ...
                      <!--------------- Search Tab start----------------->
                                        ...
                                        foreach ($orderListing as $key=>$listData){
											...
											$status ='Inactive';
											   ...
											   <td><?php echo $listData['order_tracking_number']; ?></td>
												...
												<td><?php echo $listData['barcode_qr_code_no']; ?></td>
 												<td>
  												<a class="btn btn-xs btn-success pull-right" href="<?php echo base_url().'order_master/barcode/view_order_barcode/'.$listData['product_id'].'/'.$listData['order_id'];?>"><i style="cursor:pointer" title="View Order" class="fa fa-eye icon-2x"></i></a>
                                                  </td>
                                              </tr>
                                         <?php }
										}else{ ?>

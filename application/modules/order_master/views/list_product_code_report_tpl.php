...
<?php $this->load->view('../includes/admin_top_navigation');?>
	<div class="main-container ace-save-state" id="main-container">
			...
			<?php $label = 'Product Bar/OR Codes History';?>
                                                ...
                                                <div class="widget-body">
                                                        ...
                                                        <form id="form-filter" action="" method="get" class="form-horizontal" >
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="input-group">
                                                                    <input type="text" name="search" id="search" value="<?= $this->input->get('search',null); ?>" class="form-control search-query" placeholder="Please search Product Code">
                                                    ...
                                                    <table id="missing_people" class="table table-striped table-bordered table-hover">
                                                        <thead>
															...
															<th>Parent Code if any</th>															
															<th>Product Name</th>
															<th>Product ID</th>
															<th>Activity</th>
															<th>Location Name </th>
															<th>Location ID</th>
															<th>Tracek Username</th>
															<th>Tracek user role</th>
    ...
    foreach ($PrintedCodeListing as $key=>$listData){
           ...
           <tr id="show<?php echo $key; ?>">
                                                       <td><?php echo $sno; ?></td>
								<td><?php if($listData['transaction_datetime']!='0000-00-00 00:00:00'){echo (date('j M Y H:i:s D', strtotime($listData['transaction_datetime'])));};  ?></td>
                                                      <td><?php echo getUserFullNameById($listData['created_by']); ?></td>
													  <td><?php echo $listData['created_by']; ?></td>
													   <td><?php echo $listData['scanned_code_level']; ?></td>
													  <td><?php echo $listData['product_code']; ?></td>
													  <td><?php if(getParentCodeofACode($listData['product_code'])==''){ echo "NA";}else{ echo getParentCodeofACode($listData['product_code']); } ?></td>
													  ...
													  <td><?php echo getTracekUserFullNameById($listData['agent_customer_id']); ?></td>
													  <td><?php echo $listData['agent_customer_role']; ?></td>  
													 <?php 
													 $sno++;
													 }
                                            }else{ ?>
                                            <tr><td align="center" colspan="14" class="color blue">Please search a code List Product Code's History</td></tr>
                                            <?php }?>
                                        </tbody>
                                    </table>

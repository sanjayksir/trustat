			...
			<div class="main-content">
				<div class="main-content-inner">
							...
							<div class="col-xs-12">
 								<div class="widget-box widget-color-blue">
                                                                    <div class="widget-header widget-header-flat">
                                                                        <h5 class="widget-title bigger lighter">List Post-Purchase Scan Report, you can make your selection<?php //echo date('Y-m-d', strtotime('-7 days'));
																		?><?php
													$date1 = date_create("2020-05-26 12:58:09");
													...
													//count days
													$dddd = ($diff->format("%a"))+1;
													//echo 'Days Count - '.$dddd;
													?>
					...
					<?php $dateoneMAgo = date("m/d/Y",strtotime("-1 month")); ?>	
						...
						<!-- -->
																						<!--<label><a href="#" onclick="$('#List_Consumer').tableExport({type:'excel',escape:'false'});"> <img src="<?php echo base_url();?>assets/images/download_excel.png" width="150px" style="margin-left:40px"></a></label>-->
                                                                                    </div>

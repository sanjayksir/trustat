...
<?php $this->load->view('../includes/admin_top_navigation');?>
	<div class="main-container ace-save-state" id="main-container">
			...
			<?php $label = 'Overall global inventory direct Sales to Customers details'; ?>
 											...
 											<table id="missing_people" class="table table-striped table-bordered table-hover">
 												<thead>
													<tr> 
														...
														<th>Location Name</th>
														<th>Location Type</th>
														<th>Sale Return from Customer</th>
														<th>Type of Sales Return</th>
														<th>QR Code availble on Product Returned</th>
        ...
        $sno =  $page + 1;
                                        foreach ($ScanedCodeListing as $key=>$listData){
											...
											?>
											   ...
											   <td><?php echo $listData['return_product_bar_code']; ?></td>
											   <td><?php echo $listData['product_name']; ?></td>
											   <td><?php echo $listData['product_sku']; ?></td>
											   <td><?php echo $listData['return_product_bar_code']; ?></td>
											   <td><?php echo $listData['tracek_user_id']; ?></td>
											   <td><?php echo getTracekUserFullNameById($listData['tracek_user_id']); ?></td>
											   ...
											   <td><?php $inDate = getReciptInDateatLocationByCode($listData['return_product_bar_code']); echo $inDate[0]['created_date_time']; ?></td>
												<td><?php echo $inDate[0]['invoice_number']; ?></td>
											<td><?php $OutDate = getTransferOutDateatLocationByCode($listData['return_product_bar_code']); echo $OutDate[0]['transfer_out_date']; ?></td>
												<td><?php  echo Check_Packed_Status($listData['return_product_bar_code']); ?></td>
				<td><?php $PackagingChildDetails = getProductCodePackagingChildDetails($listData['return_product_bar_code']); echo $PackagingChildDetails[0]['parent_pack_level']; ?></td>
												<td><?php echo $PackagingChildDetails[0]['parent_bar_code']; ?></td>
				<td><?php $PackagingParentDetails = getProductCodePackagingParentDetails($listData['return_product_bar_code']); echo $PackagingParentDetails[0]['packaging_level']; ?></td>
												<td><?php echo $PackagingParentDetails[0]['bar_code']; ?></td>
												...
												<td><?php echo getPrintBatchIDByProductCode($listData['return_product_bar_code']); ?></td>
												 <td>
<a href="<?php echo base_url().$listData['returning_item_image'];?>" onclick="window.open (this.href, 'child', 'height=800,width=900'); return false"><img alt="Returned Product Image?" src="<?php echo base_url(). $listData['returning_item_image'];?>" height="50" width="50"></a>
												</td>									  
												</tr>
                                         <?php }
										}else{ ?>

...
<?php $this->load->view('../includes/admin_top_navigation');?>
	<div class="main-container ace-save-state" id="main-container">
			...
			<?php $label = 'Overall global inventory product stock transfer out details'; ?>
        ...
        $sno =  $page + 1;
                                        foreach ($ScanedCodeListing as $key=>$listData){
											...
											?>
											   ...
											   <td><?php $inDate = getReciptInDateatLocationByCode($listData['bar_code']); echo $inDate[0]['created_date_time']; ?></td>
											<td><?php echo $inDate[0]['invoice_number']; ?></td>
											<td><?php  echo Check_Packed_Status($listData['bar_code']); ?></td>
											<td><?php $PackagingChildDetails = getProductCodePackagingChildDetails($listData['bar_code']); echo $PackagingChildDetails[0]['parent_pack_level']; ?></td>
											<td><?php echo $PackagingChildDetails[0]['parent_bar_code']; ?></td>
				<td><?php $PackagingParentDetails = getProductCodePackagingParentDetails($listData['bar_code']); echo $PackagingParentDetails[0]['packaging_level']; ?></td>
												...
												<td><?php echo getPrintBatchIDByProductCode($listData['bar_code']); ?></td>

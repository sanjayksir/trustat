                                            ...
                                            foreach ($orderListing as $listData){
												...
												<tr>
                                                   ...
                                                   <td><?php  echo $listData['barcode_qr_code_no']; ?></td>
                                                       <td><a title="Click here to View Product Details" href="<?php echo base_url();?>backend/product_attrribute/view/<?php echo $listData['product_id'];?>" class="">
 																<?php  echo get_products_name_by_id($listData['product_id']); ?>

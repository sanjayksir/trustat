...
<!-- /Export to Excel -->
	...
	<div class="main-container ace-save-state" id="main-container">
			...
			<?php $label = 'Unpacked Inventory in hand List Codes';?>
							...
							<div class="col-xs-12">
 								<div class="widget-box widget-color-blue">
                                                                    <div class="widget-header widget-header-flat">
                                                                        <h5 class="widget-title bigger lighter">List <?php echo $label;?>-<?php echo $this->uri->segment(6); ?></h5>
																		 <div class="widget-toolbar">
                                                    <?php echo anchor('reports/inventory/unpacked_inventory_in_hand_list_codes_download/'.$this->uri->segment(4).'/'.$this->uri->segment(5), 'Go to download report',array('class' => 'btn btn-xs btn-warning')); ?>
																	</div>
                                                                    </div>

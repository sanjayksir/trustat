							...
							<div class="col-xs-12">
 								<div class="widget-box widget-color-blue">
                                                                    <div class="widget-header widget-header-flat">
                                                                        <h5 class="widget-title bigger lighter">List <?php echo $label;?> <?php if($this->uri->segment(2)=='overall_global_inventory_in_hand_all_records_download'){ 
													echo " Archived"; } ?></h5>
																		 <div class="widget-toolbar">
                                                    <?php echo anchor('reports/overall_global_inventory_in_hand', ' Back ',array('class' => 'btn btn-xs btn-warning')); ?>
																	</div>
                                                                    </div>

      ...
      <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        ...
        <ul class="breadcrumb">
          ...
          <li> <i class="ace-icon fa fa-home home-icon"></i> <a href="<?php echo site_url(); ?>">Home</a> </li>
		 				...
		 				<?php $constant = "Reply Consumer Complaint" ; ?>	
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-12">
                            ...
                            <div class="row" id="add_edit_div">
                              ...
                              <?php  $this->load->view('reply_consumer_complaint_right_tpl'); ?>
 ...
 $(document).ready(function(){	
	...
	$("form#user_frm").validate({
		...
		messages: {
				...
				comments: {
					required: "Please give your comments.",
					minlength: "Minimum 4 Characters are required" ,
					maxlength : "Maximum 5000 Characters can be entered" 
				}
			...
			var dataSend 	= $("#user_frm").serialize();
			 //formData 		= new FormData();
   			...
   			$.ajax({
				...
				url: "<?php echo base_url(); ?>order_master/save_reply_consumer_complaint_by_customer/",
				//window.location.href="<?php echo base_url().'order_master/reply_consumer_complaint' . $get_registered_products_by_consumers_details[0]['id'];?>";
				data: dataSend,

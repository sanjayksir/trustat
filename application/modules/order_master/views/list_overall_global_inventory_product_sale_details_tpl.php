        ...
        $sno =  $page + 1;
                                        foreach ($ScanedCodeListing as $key=>$listData){
											...
											?>
											   ...
											   <td><?php echo $listData['scan_sold_bar_code']; ?></td>
											   ...
											   <td><?php $inDate = getReciptInDateatLocationByCode($listData['scan_sold_bar_code']); echo $inDate[0]['created_date_time']; ?></td>
												<td><?php echo $inDate[0]['invoice_number']; ?></td>
												<td><?php $OutDate = getTransferOutDateatLocationByCode($listData['scan_sold_bar_code']); echo $OutDate[0]['transfer_out_date']; ?></td>
												<td><?php echo $OutDate[0]['invoice_number']; ?></td>
												<td><?php  echo Check_Packed_Status($listData['scan_sold_bar_code']); ?></td>
				<td><?php $PackagingChildDetails = getProductCodePackagingChildDetails($listData['scan_sold_bar_code']); echo $PackagingChildDetails[0]['parent_pack_level']; ?></td>
												<td><?php echo $PackagingChildDetails[0]['parent_bar_code']; ?></td>
				<td><?php $PackagingParentDetails = getProductCodePackagingParentDetails($listData['scan_sold_bar_code']); echo $PackagingParentDetails[0]['packaging_level']; ?></td>
												...
												<td><?php echo getPrintBatchIDByProductCode($listData['scan_sold_bar_code']); ?></td>

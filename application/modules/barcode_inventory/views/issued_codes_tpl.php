                ...
                <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                    ...
                    <div class="page-content">
                            <div class="alert alert-block alert-success" style='display:none;'>
                                                    ...
                                                    <i class="ace-icon fa fa-check green"></i><?php echo $label;?> Placed Successfully!!
                             </div>
                            <div class="row">
                                    <div class="col-xs-12">
                                        <div class="widget-box widget-color-blue">
                                            <div class="widget-header widget-header-flat">
                                                ...
                                                <div class="widget-toolbar">
                                                    ...
                                                    <a href="javascript:void(0);" class="btn btn-xs btn-warning" title="Make Order" data-toggle="modal" data-target="#myModal">Issue More Codes</a>
                                                </div>
                                            </div>

...
class Barcode_inventory extends MX_Controller {
    ...
    public function receive_codes() {
        ...
        list($data['total'],$data['items']) = $this->BarcodeInventoryModel->getInventory($limit,$offset,$query);
    ...
    public function issue_codes() {
        ...
        $user_id = $this->session->userdata('admin_user_id');
        //$data['orderListing'] 	= $this->order_master_model->get_order_list_all($user_id);
        $this->load->view('issue_codes_tpl', $params);
    }
    ...
    public function issued_codes() {
        ...
        $user_id = $this->session->userdata('admin_user_id');
        //$data['orderListing'] 	= $this->order_master_model->get_order_list_all($user_id);
        $this->load->view('issued_codes_tpl', $params);
    }
    ...
    public function list_orders_plant_controlllers() {
        ...
        if ($total_records > 0) {
            ...
            $config['base_url'] = base_url() . 'order_master/list_order_plant_ctrl_tpl';
    ...
    public function save_order() {
        ...
        echo $this->order_master_model->save_orders($savedData);
        exit;
    }
    ...
    public function change_status() {
        ...
        //$user_id 	= $this->session->userdata('admin_user_id');		
        echo $status = $this->order_master_model->change_status($id, $status);
        exit;
    }
    ...
    public function change_order_status() {
        $id = $this->input->post('id');
        $status = $this->input->post('value');
        echo $status = $this->order_master_model->change_order_status($id, $status);
        exit;
    }
    ...
    public function getProductList() {
        ...
        foreach ($product_data as $res) {
            ?>
            <option value="<?php echo $res['id']; ?>" <?php if (in_array($res['id'], $assigned_arr)) {
                echo 'selected';
    ...
    public function change_assign_product_status() {
        ...
        //$user_id 	= $this->session->userdata('admin_user_id');		
        echo $status = $this->plant_master_model->qry_change_assign_product_status($id, $status);
        exit;
    }
    ...
    public function getPlantList() {
        ...
        foreach ($product_data as $res) {
            ?>
            <option value="<?php echo $res['plant_id']; ?>" <?php if (in_array($res['plant_id'], $assigned_arr)) {
                echo 'selected';
            } ?>><?php echo $res['plant_name']; ?></option>
        <?php
        }
        return $result;
    }
    ...
    public function change_assign_plant_status() {
        ...
        //$user_id 	= $this->session->userdata('admin_user_id');		
        echo $status = $this->plant_master_model->qry_change_assign_plant_status($id, $status, $plantsId);
        exit;
    }

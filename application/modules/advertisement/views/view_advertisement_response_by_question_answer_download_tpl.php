	...
	<div class="main-container ace-save-state" id="main-container">
			...
			<div class="main-content">
				<div class="main-content-inner">
							...
							<div class="col-xs-12">
 								<div class="widget-box widget-color-blue">
                                                                    <div class="widget-header widget-header-flat">
                                                                        <h5 class="widget-title bigger lighter">Download Advertisement Closure Report, you can also make your selection by dates<?php //echo $label;?><?php //echo $this->uri->segment(3);?>
					...
					<a href="<?php echo base_url();?>advertisement/view_advertisement_response_by_question_answer/<?php echo $this->uri->segment(3);?>" class="btn btn-xs btn-warning"> Back </a>								
																	</div>	
																		</h5>
                                                                    </div><br /> <br />
			...
			<option value="<?php echo $mnvtext58; ?>"><?php echo $mnvtext58; ?></option>																				
					...
					<div class="col-sm-2" style="margin-left:40px">  Start Date(mm/dd/yyyy) : <br /><br />End Date(mm/dd/yyyy) :<br /><br />  </div>
                                                                                    <div class="col-sm-7">

     ...
     <div class="main-content-inner">
       ...
       <div class="page-content">
		...
		<div class="form-group row">
			...
			<div class="form-control"><?php echo date('d/M/Y',strtotime($listData['created_by'])); ?></div>
			</div>
			 
			
			<div class="col-sm-6">
			  <label for="form-field-8">Order Date</label>
			 <div class="form-control"><?php echo $getData['created_date'];?></div>
			</div>
		</div>
		...
		<div class="form-group row">
			<div class="col-sm-6">
             ...
             <div class="form-control"><?php echo order_status($getData['status']);?></div>
			</div>
 		</div>

...
<div class="col-xs-12">
		...
		<div class="form-group row">
			<div class="col-sm-6">
			<label for="form-field-8">Approval Number</label>
			<input name="coupon_number" id="coupon_number" type="text" class="form-control" placeholder="Approval Number" value="<?php echo $get_loyalty_redemption_requests_details[0]['coupon_number'];?>">
			</div>
			<div class="col-sm-6">
			  <label for="form-field-8">Payment Type/Mode</label>
             <input name="coupon_type" id="coupon_type" type="text" class="form-control" placeholder="Payment Type/Mode" value="<?php echo $get_loyalty_redemption_requests_details[0]['coupon_type'];?>">
			</div>
		</div>
		<!--<div class="form-group row">
			<div class="col-sm-6">

      ...
      <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        ...
        <ul class="breadcrumb">
          ...
          <li> <i class="ace-icon fa fa-home home-icon"></i> <a href="<?php echo site_url(); ?>">Home</a> </li>
		 				...
		 				<?php if($this->uri->segment(2)=='edit_product_referral_response_message_options'){

								  	$constant = "Edit Product Referral Option" ;

                              }else{ // $this->load->view('add_member_right_tpl'); 
							  $constant = "Add Product Referral Option" ;

					 			}?>	
          <li class="active">Add</li><li class="active"><?php echo $constant;?></li>
                          ...
                          <div class="col-xs-12">
                            ...
                            <div class="row" id="add_edit_div">
                              ...
                              <?php if($this->uri->segment(2)=='edit_product_referral_response_message_options'){
								  	...
								  	$this->load->view('edit_product_referral_response_message_options_tpl'); 
	
                              }else{  $this->load->view('add_product_referral_response_message_options_tpl'); 
   			...
   			$.ajax({
				...
				data: dataSend,
  				success: function (msg) {
					setTimeout(function() {
 						  window.location.href="<?php echo base_url().'product/ask_product_referral_response_message_options/' . $this->uri->segment(3);?>";
					  }, 2000); 
				}
			});
  		}

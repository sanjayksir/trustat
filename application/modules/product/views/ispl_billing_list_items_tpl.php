                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="widget-box widget-color-blue">
                            <div class="widget-header widget-header-flat">
                                <h5 class="widget-title bigger lighter">ISPL Billing Report <?php if($this->session->userdata('admin_user_id')==1){ echo "for " . getUserFullNameById($this->uri->segment(3)); }?> <?php //echo $this->uri->segment(3); ?>
								<div class="widget-toolbar">
                                        <?php echo anchor('product/ispl_billing_list_items_download/'.$this->uri->segment(3), 'Go to download report',array('class' => 'btn btn-xs btn-warning')); ?>
								</div>
                              ...
                              <input type="text" name="from_date_data" id="from_date_data" readonly="readonly" value="<?php //echo $dateoneMAgo; ?>" class="form-control" />
                               ...
                               <input type="text" name="to_date_data" id="to_date_data" readonly="readonly" value="<?php //echo $Datetoday; ?>" class="form-control" />
								  ...
								  <input type="hidden" name="c_date_data" id="c_date_data" value="<?php echo date('m/d/Y'); ?>" class="form-control" />	
                                                <input type="text" name="search" id="search" value="<?= $this->input->get('search',null); ?>" class="form-control search-query" placeholder="Search Customer Billing Master Name Or Quantity">

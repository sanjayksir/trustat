                            ...
                            <div class="col-xs-12">
								...
								<div class="form-group row">
								 ...
								 <div class="table-header">
                                    Product Video Feedback Question Listing
                                 </div>
								<!--------------- Search Tab start----------------->
                            <div class="form-group row">
                            <div class="col-sm-10">
                                ...
                                <table id="search" class="table table-hover display">
                                 ...
                                 </div> <div class="col-sm-2 pull-right"><?php echo anchor('product/add_video_feedback/'.$product_id.'/', 'Add New Question',array('class' => 'btn btn-primary pull-right')); ?></div>

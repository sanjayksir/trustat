<?php
		$dt = $edit_demo_audio_feedback_data[0];
		?>
<div class="col-xs-12">
  ...
  <div class="widget-box">
    ...
    <div class="widget-header">
      ...
      <h4 class="widget-title">Edit Product Referral Option</h4>
     ...
     <div id="ajax_msg"></div>
       ...
       <form name="user_frm" id="user_frm" action="#" method="POST">
		 ...
		 <div class="form-group row">
			<div class="col-sm-12">
			<label for="form-field-8">Option Type<?php //echo $this->uri->segment(3); ?></label> <?php //echo basename(parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH)); ?>
			<select name="QuestionType" id="questiontype" class="form-control">
             <!-- <option value="0">-Select Option Type-</option>
					...
					<option value="Demonstration" selected>Product Demo Audio Feedback</option>-->
					<option value="ProductReferralResponseMessage" selected>Product Referral Title message</option>
             </select>
			</div>
		</div>
...
-->					
 		...
 		<div class="form-group row">
			<div class="col-sm-12">
			<label for="form-field-8">Product Referral Title Message</label>
		...
		<div class="form-group row">
			<div class="col-sm-6">
			<label for="form-field-8">Product Referral Message Option1:</label>
             <input name="answer1" id="answer1" type="text" value="<?php echo $dt['answer1']; ?>" class="form-control" placeholder="Option 1"  maxlength="150">
			</div>
			
			<div class="col-sm-6">
			  <label for="form-field-8">Product Referral Message Option2:</label>
		...
		<div class="form-group row">
			<div class="col-sm-6">
			<label for="form-field-8">Product Referral Message Option3:</label>
             <input name="answer3" id="answer3" type="text" value="<?php echo $dt['answer3']; ?>" class="form-control" placeholder="Option 3"  maxlength="150">
			</div>
			
			<div class="col-sm-6">
			  <label for="form-field-8">Product Referral Message Option4:</label>
        ...
        <div class="form-group row">
			<div class="col-sm-4">
			 <label for="form-field-8">Most Appropriate Option:</label>
             <select name="correctAns" id="correctAns" class="form-control" >
              <option value="0">-Select Most Appropriate Option-</option>
			 	  <?php  for($i=1;$i<=4;$i++){?>   
          ...
          <div class="clearfix form-actions" style="background-color:white;border-top: none;padding:0px;">
             ...
             <input class="btn btn-info" type="submit" name="submit" value="Save Question" id="save" onClick="this.disabled; this.value='Saving…';" />

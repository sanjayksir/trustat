        ...
        <div class="main-content-inner">
            ...
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Product PDF Feedback Questions</li>
                </ul><!-- /.breadcrumb -->           
            </div>
                            ...
                            <div class="col-xs-12">
								...
								<div class="form-group row">
								 ...
								 <div class="table-header">
                                    Product PDF Feedback Question Listing
                                 </div>
								<!--------------- Search Tab start----------------->
                            <div class="form-group row">
                            <div class="col-sm-10">
                                ...
                                <table id="search" class="table table-hover display">
                                 ...
                                 </div> <div class="col-sm-2 pull-right"><?php echo anchor('product/add_pdf_feedback/'.$product_id.'/', 'Add New Question',array('class' => 'btn btn-primary pull-right')); ?></div>
                                             ...
                                             <tr id="show<?php echo $attr['question_id'];?>">
											   ...
											   <form name="frm_<?php echo $attr['question_id'];?>" id="frm_<?php echo $attr['question_id'];?>" method="post" action="">
 														<div class="hidden-sm hidden-xs btn-group">
   															<a href="<?php echo base_url();?>product/edit_pdf_feedback/<?php echo $attr['product_id'];?>/<?php echo $attr['question_id'];?>" class="btn btn-xs btn-info">

        ...
        <div class="main-content-inner">
            ...
            <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                <ul class="breadcrumb">
                    ...
                    <li class="active">Product Referral Title message Options</li>
                </ul><!-- /.breadcrumb -->           
            </div>
                               ...
                               <h3 class="header smaller lighter blue">Product Name - <?php echo get_products_name_by_id($this->uri->segment(3)); ?></h3>
								...
								<div class="form-group row">
								 ...
								 <div class="table-header">
                                    Product Referral Title message Options Listing
                                 </div>
								<!--------------- Search Tab start----------------->
                            <div class="form-group row">
                            <div class="col-sm-10">
                                ...
                                <table id="search" class="table table-hover display">
                                 ...
                                 </div> <div class="col-sm-2 pull-right"><?php echo anchor('product/add_referral_response_message_options/'.$product_id.'/', 'Add an Option',array('class' => 'btn btn-primary pull-right')); ?></div>
                                             ...
                                             <tr id="show<?php echo $attr['question_id'];?>">
											   ...
											   <form name="frm_<?php echo $attr['question_id'];?>" id="frm_<?php echo $attr['question_id'];?>" method="post" action="">
 														<div class="hidden-sm hidden-xs btn-group">
   															<a href="<?php echo base_url();?>product/edit_product_referral_response_message_options/<?php echo $attr['product_id'];?>/<?php echo $attr['question_id'];?>" class="btn btn-xs btn-info">
...
function delete_feedback_question(question_id){  if (confirm("Sure to Delete this Product Referral Title message Options?") == true) {

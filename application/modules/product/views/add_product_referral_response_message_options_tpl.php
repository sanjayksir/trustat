<div class="col-xs-12">
  ...
  <div class="widget-box">
    ...
    <div class="widget-header">
      ...
      <h4 class="widget-title">Add Product Referral Option</h4>
     ...
     <div id="ajax_msg"></div>
       ...
       <form name="user_frm" id="user_frm" action="#" method="POST">
		 ...
		 <div class="form-group row">
			<div class="col-sm-12">
			<label for="form-field-8">Option Type</label> <?php //echo basename(parse_url($_SERVER['REQUEST_URI'], PHP_URL_PATH)); ?>

  ...
  class User_master extends MX_Controller {
     ...
     public function list_user() {
		...
		if ($total_records > 0) 
        {
            ...
            $config['base_url'] = base_url() . 'user_master/list_user';
	...
	public function list_plevel_user() {
	 ...
	 $user_id 	= $this->session->userdata('admin_user_id');
 		...
 		if(empty($user_id) || empty($user_name)){
		  ...
		  echo $this->myspidey_user_master_model->update_profile_data($searcharray);  exit;
	   ...
	   public function change_status() {
		 ...
		 //$user_id 	= $this->session->userdata('admin_user_id');		
		 echo $status= $this->myspidey_user_master_model->change_status($id,$status);exit;
      }
 	  ## get city list

      ...
      <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        ...
        <ul class="breadcrumb">
          ...
          <li> <i class="ace-icon fa fa-home home-icon"></i> <a href="<?php echo site_url(); ?>">Home</a> </li>
		 				...
		 				<?php $constant = "Confirm Delete Customer" ; ?>	
                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-12">
                            ...
                            <div class="row" id="add_edit_div">
                              ...
                              <?php  $this->load->view('delete_user_accept_otp_right_tpl'); ?>
		...
		submitHandler: function(form) {
			...
			formData 		= new FormData();
 			...
 			$.ajax({
				...
				url: "<?php echo base_url(); ?>user_master/update_common_point_master_otp/",

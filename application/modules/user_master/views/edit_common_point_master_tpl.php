                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-12">
                            ...
                            <div class="row" id="add_edit_div">
                              ...
                              <?php  $this->load->view('edit_common_point_master_right_tpl'); ?>
		...
		submitHandler: function(form) {
			...
			formData 		= new FormData();
 			...
 			$.ajax({
				...
				url: "<?php echo base_url(); ?>user_master/update_common_point_master/",
				...
				success: function (msg) {
						...
						window.location.href="<?php echo base_url(); ?>user_master/list_common_points_loyalty";						

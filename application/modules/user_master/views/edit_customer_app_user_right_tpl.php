			...
			<div class="col-sm-4">
			 ...
			 <!--<input name="l_name" id="l_name" type="text" value="<?php echo $get_user_details[0]['l_name'];?>" class="form-control" placeholder="Last Name"  maxlength="30">-->
			  <select name="l_name" id="l_name" class="form-control">
				  <option value="<?php echo $get_user_details[0]['l_name'];?>"><?php echo $get_user_details[0]['l_name'];?></option>
		...
		<div class="form-group row">
                <div class="col-sm-6">
					...
					<option value="<?php echo get_assigned_active_plants_list($get_user_details[0]['user_id']);?>" selected><?php echo assigned_plants($get_user_details[0]['user_id']);?></option>
                        ...
                        <?php echo Utils::selectOptions('plant_id', ['options' => $plants, 'empty' => 'Select any other Plant', 'value' => Utils::elemValue('plant_id', $_POST)]) ?>
                    </select>
                </div>
            </div>

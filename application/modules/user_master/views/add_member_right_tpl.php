...
<?php $random_no = random_num(9);?>
		...
		<?php if($this->uri->segment(3)!=""){?>
			...
			<input name="f_name" id="f_name" type="text" class="form-control" placeholder="<?php echo getUserFullNameById($this->uri->segment(3)); ?>" value="<?php echo getUserFullNameById($this->uri->segment(3)); ?>" readonly="" >
			</div>
			<?php }else{ ?>
			<div class="col-sm-4">
			  <label for="form-field-8">Organization Name</label>
			<input name="f_name" id="f_name" type="text" class="form-control" placeholder="Organization Name">
			</div>
			<?php } ?>
			<div class="col-sm-4">
           ...
           <option value="">-Select Industry-</option>
			...
			<div class="col-sm-4">
             ...
             <input name="complaint_email_id" id="complaint_email_id" type="text" class="form-control" placeholder="Complaint Email ID" maxlength="50">
			</div>
			
			<div class="col-sm-4">
			  <label for="form-field-8">Feedback Email ID</label>
             <input name="feedback_email_id" id="feedback_email_id" type="text" class="form-control" placeholder="Feedback Email ID" maxlength="50">
			</div>
</fieldset>
		<hr />
		<fieldset>
		...
		<?php if($this->session->userdata('admin_user_id')==1){?>
			...
			<input name="loyalty_point_weightage" id="loyalty_point_weightage" type="number" value="100" class="form-control" placeholder="Loyalty Point weightage with compare to currency in %" max="100" min="0">
			</div>
		...
		<div id="hidden_div2" style="display:none;">		
			...
			<input name="percent_lty_pts_consumer_red_cashier" id="percent_lty_pts_consumer_red_cashier" type="number" value="0" class="form-control" placeholder="% of Loyalty Points for consumer to be redeemed" max="100" min="0">
			</div>

							...
							<div class="col-xs-12">
 								<div class="row">
									 <div class="col-xs-12">
 										...
 										<div style="clear:both;height:40px;"><a href="<?php echo base_url()?>user_master/add_customer_app_user/" class="btn btn-primary pull-right" title="Add Customer App User">Add <?php echo $label;?> </a></div> 

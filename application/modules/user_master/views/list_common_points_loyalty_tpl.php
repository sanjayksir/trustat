...
<tr id="show<?php echo $listData['id']; ?>">
                                           <td><?php echo $sno;$sno++; ?></td>
												...
												<td><?php echo $listData['active_status']; ?></td>
												 ...
												 <?php echo anchor("user_master/edit_common_point/" . $listData['id'], '<i class="ace-icon fa fa-pencil bigger-130"></i>', array('class' => 'btn btn-xs btn-info','title'=>'Edit')); ?>

                        ...
                        <div class="row">
                          ...
                          <div class="col-xs-12">
                            ...
                            <div class="row" id="add_edit_div">
                              ...
                              <?php  $this->load->view('edit_profile_right_tpl'); ?>
		...
		submitHandler: function(form) {
			...
			formData.append('file', $('#file')[0].files[0]);
 			...
 			$.ajax({
				...
				url: "<?php echo base_url(); ?>user_master/update_profile/",
				...
				success: function (msg) {
					...
					if(parseInt(msg)==1){
						...
						$('#user_frm')[0].reset(); 
						 ...
						 window.location.href="<?php echo base_url(); ?>user_master/profile_user/";						

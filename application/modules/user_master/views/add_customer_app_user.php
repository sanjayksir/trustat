        ...
        <ul class="breadcrumb">
          ...
          <li> <i class="ace-icon fa fa-home home-icon"></i> <a href="<?php echo site_url(); ?>">Home</a> </li>
		 				...
		 				<?php 
								...
								$type 				= "Customer User";
								if($this->session->userdata('admin_user_id')>1 || $this->uri->segment(2)=='add_customer_app_user' || $this->uri->segment(2)=='edit_plant_controller'){
									$type 			= "Customer App User";
									$urlredirect 	= 'list_customer_app_users';
								}
